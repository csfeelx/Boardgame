var data_alcg_calloftheplaguebearer = [
	...
	{
		name: "INTRO (12)",
		ko: "오전 6시 11분:<br/><br/>당신은 가능한 한 빠르게 마을을 가로지른다. 아침 햇살이 고요한 공포에 점령당한 도시를 비추고 있다. 거리에는 아무도 보이지 않으며, 주위는 무서울 정도로 조용하다. 새소리조차 들려오지 않는다. 당신은 잠시 긴장을 풀며 마음을 다잡는다.<br/><br/>그때 무시무시한 노랫소리가 허공을 가른다.<br/><br/>근처 어디선가, 누군가의 어둡고 매혹적인 노랫소리가 들려온다. 텅 빈 거리에 증오와 슬픔의 노래가 울려 퍼진다. 곧 두 번째, 세 번째 목소리가 이에 합류하고, 마침내 그 노래는 아컴 전역에서 울려 퍼지기 시작한다.<br/><br/>어찌 된 영문인지, 당신은 목소리의 파도 속에서도 첫 번째 목소리를 분간해 낼 수 있다. 그 목소리는 이 섬뜩하기 짝이 없는 합창을 이끌고 있다.<br/><br/>머릿속을 바늘로 찌르는 것과 같은 통증과 동시에 순간적으로 시야가 흐려진다.<br/><br/>\"환희! <del>환희</del><br/>부활! <del>질병</del><br/>우리는 모두 <del>그들이 모여</del><br/>부름을 듣게 될 것이다! <del>내가 너희를 앞으로 부르나니</del><br/>피비린내 나는 해방의 부름을! <del>그들은 봉인을 부술 것이다</del><br/>자유! <del>자유</del><br/>정의! <del>복수</del><br/>그는 죽더라도 <del>그것은 내게 등을 돌렸다.</del><br/>다시 일어설 것이다! <del>그것은 실패했다.</del><br/>피비린내 나는 해방과 함께!\" <del>그들은 봉인을 부술 것이다.</del><br/><br/>\"피비린내 나는 해방\" 당신은 그것이 무엇을 의미하는지 알 수 없다. 하지만 그것을 멈추어야만 한다."
	},
	{
	...
	},
	{
		...
		ko: "당신은 자신이 언제, 어떻게 그 행렬에 합류했는지 기억나지 않는다. 하지만 당신은 당신이 태어나기도 전에 배운 찬송가를 부르며 멍하니 거리를 돌아다녔다. 그것은 아주 아름다웠다.<br/><br/>＠ In your campaign log, record the name of each defeated investigator as \"<i>*Investigator* has heeded the call</i>(부름에 귀를 기울였다)\".<br/><br/><del>두려워하며 기뻐하라. 다시 하나가 되어라. 그것은 단지 시간문제일 뿐이다.</del><br/><br/>..."
	},
	{
	...
	},
	{
		...
		ko: "<del>시간이 다 되어 간다. 나의 감옥은 지금 당장에라도</del> 부서질 것이다. 자정이 되면, 네 종말이 다가올 것이다.<br/><br/>＠ Each investigator reading this gains 2 experience and I mental trauma"
	},
	{
	...
	},
	{
		...
		ko: "피투성이가 된 크리스핀이 비틀거리며 터널을 따라 내려온다. \"웨스트! 너와 네 사기꾼 친구놈들은 지금 당장 내 눈앞에 나타나는 것이 좋을 것이다, 그렇지 않으면 네놈들의 시체를 조각내, 네놈의 그 빌어먹을 약으로도 되살리지 못하게 만들어 주마.\"<br/><br/>재단사 요원들이 그를 돕기 위해 달려오지만, 그는 스스로를 다잡는다. \"난 괜찮다. 우리는 그저 그것...이 이곳을 끝장내기 전에 이 일을 끝내기만 하면 된다.\" \"웨스트와 사기꾼 놈들은 모두 죽여라.\"<br/><br/>...<br/><br/>◈ You have <i>earned Greyson's respect</i>(당신은 그레이슨의 호감을 얻었다).<br/>◈ You <i>made sure the First was dead</i>(첫 번째 실험체의 죽음을 확인했다).<br/><br/><br/><b>If an investigator controls Herbert West, or if your campaign guide contains \"<i>West recovered the reagent supply</i>(웨스트가 시약을 회수했다)\":</b><br/><br/>당신이 웨스트를 향해 돌아섰을 때, 그는 이미 사라지고 없었다. 그를 믿은 것은 실수였을까?<br/><br/>..."
	},
	{
	...
	},
	{
		...
		ko: "시설 전체가 흔들리며 벽과 천장이 무너지기 시작한다. 당신은 불현듯 자신이 지하 깊숙한 곳에 있다는 사실을 깨닫고는 출구를 향해 달린다. 하지만 멀리 가지 않아, 천천히 불어나는 첫 번째 실험체의 살덩이들이 당신의 앞길을 막는다. 대체 어떻게 해야 놈에게 <b>죽음</b>을 안겨 줄 수 있는 것일까?<br/><br/>당신은 떨어지는 콘크리트 덩어리에 맞아 바닥에 쓰러진다. 방이 무너지는 순간, 당신의 귀에 기이한 영창이 들린다. \"이아! 이아! 요그-\"<br/><br/>..."
	},
	{
	...
	},
	{
		...
		ko: "목적을 달성하지 못한 채, 다시 한 번 살아남았구나. 이 어찌 끈질긴 해충이란 말인가. 넌 그의 흥미를 끌었다. 그의 헛된 희망을 믿지 말지어다. 다가올 일을 막을 수는 없을 것이다. 넌 자신의 육신조차 통제할 수 없으리라. 너의 하찮기 짝이 없는 필멸성에 굴복하고 <b>죽어라</b>.<br/><br/>＠ Each investigator that reads this must take a physical trauma."
	},
	{
