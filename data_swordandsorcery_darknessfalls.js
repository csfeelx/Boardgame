var data_swordandsorcery_darknessfalls = [
	...
	{},
        ...
        },
        {
                ...
                ko: "한때는 무성한 정원이던 것이 지금은 열린 무덤으로, 그 곳에서 크리머들이 썩은 대리석 위에 군림하고 있다. 한때 아름다운 이 정원의 중심에는 창 위에 시체가 박혀 있는데, 예상치 못한 방문객들에게는 암울한 경고다. 시체는 문차일드로부터 온 정찰병의 너덜너덜한 유니폼을 입고, 검고 초췌한 까마귀들의 잔치를 잔치한다."
        },
        {
                name: "$5.2 (Waypoint 1)",
