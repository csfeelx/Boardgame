var data_swordandsorcery_darknessfalls = [
	...
	},
	{
		...
		ko: "고참 경비병 하나가 당신 앞으로 다가와, 경례를 한 뒤 말한다. \"당신과 함께 싸울 수 있었던 것은 명예로운 일이었습니다. 영웅이시여. 쓰러진 동료들과 당신께 영광을!\" 그리고 그는 당신과 힘차게 악수를 나눈 뒤, 깊숙히 허리를 숙이며 작별을 고한다."
	},
	{
		name: "$1.3 (Waypoint 1)",
	...
	},
	{
		...
		ko: "떠오르는 새벽 태양의 첫 빛줄기가 건물 높은 곳의 장식된 창문을 통해 쏟아져 들어온다. 그 빛이 뱀파이어의 피부에 닿자, 그 괴물은 고통에 찬 비명을 지른다. 태양빛에 겁먹은 그는 주문을 외워 몇몇 궁전 경비병들을 매혹해, 군중들을 공격하게 한 뒤, 그의 그림자와 같은 망토로 몸을 가리고, 안개 속으로 스며들어 궁전의 지하 쪽으로 사라진다.<br>반복된 시도 끝에 마르커스 사제는 간신히 궁전의 문을 열고, 손님들을 위한 퇴로를 확보한다. 그는 영웅들에게 돌아서서 말한다. \"우리는 그 붉은 머리의 여자가 도시를 떠나기 전에, 그녀를 찾아야 합니다. 그녀가 달브 백작에 대해 우리가 알고 있는 것 보다 더 많은 것을 알고 있는 것이 분명합니다.\""
	},
	{
	...
	{
		name: "$1.17 (Event 4)",
		en: "Through the chaos and fear gripping the city, the heroes manage to find the woman as she tries to disappear into the crowd. The heroes, already engaged in battle with their enemies, signal Marcus and his warrior priests to take the woman into custody until the fight ends.",
		ko: "혼돈과 공포로 뒤덮힌 도시에서, 영웅들은 군중 속으로 숨어들려던 그 여자를 찾아낸다. 적들과 전투로 여유가 없는 영웅들은 마르커스와 그의 전투 사제들에게 싸움이 끝날 때 까지 그녀를 구금하라고 신호를 보낸다."
	},
	{
	...
	},
	{
		...
		ko: "\"당신들이 싸운 놈들은 동굴에 사는 놈들이외다. 놈들은 예전엔 작은 무법자 무리에 불과했지, 하지만 최근 몇주 이 동네의 모든 악당들이 놈들 무리에 들어가길 원했다오. 놈들을 끌어들이는 뭔가가 있어, 이상하지? 이런 놈들이 이렇게 뭉쳐 다니는 건 흔치 않은 일이지 않소. 아마도 두목의 카리스마 때문일지도 모르겠소. 알타이어 라는 놈이지. 놈의 목소리는 엄청나게 매혹적이라오, 아 글쎄, 이 개똥같은 동네에 있으면서도 멋진 여자들을 잔뜩 데리고 있다니까. 물론 이 자리에 놈은 없었지, 하지만 놈이 부하인 뼈 파괴자가 죽었다는 이야기를 듣게 되면 그리 기뻐하진 않을껄. 당신이 이 동네에 들어왔을 때, 망꾼놈들이 이미 눈치를 챘다고. 보고를 받은 알타이어가 습격을 명했지만, 실수가 되었지. 뭐 이 동네에 당신같은 사람들은 흔치 않으니까 말이야. 무슨 일이 있었던 것이 분명해. 놈들은 당신들이 죽기를 원했던 것 같아. 가지고 있는 것들을 노렸을 수도 있지. 당신들은 쉬운 먹잇감으로 보이거든, 아마도? 잘 모르겠네.\"<br>\"그 젠장맞을 놈들은 당신들을 습격할 때 내가 앞에서 싸우길 바랬지. 하지만 난 살인자 타입은 아니라오. 나는 그저 살아남길 원한다고. 생존자 타입이지. 거기에 나는 내가 싸움에 끼어들었다면 살아남지 못했으리라는 걸 안다오. 당신들과 맞서 싸운다니... 말도 안되지. 뭐. 이렇게 된거외다.\""
	},
	{
	...
	},
	{
		...
		ko: "\"거래한거요!\" 말락은 수풀속으로 사라졌다가 잠시 후, 빛나는 액체가 들어있는 정교하게 만들어진 약병하나를 들고 나타난다. \"여기 있소이다. 이제 떠납시다. 곧 내 동굴 친구들이 모여들테고, 난 끈적하게 작별하는 사람은 아니거든. 당신들도 알잖소. 그 질질 짜는 것 하며... 그런것들 말이오. 여기서 벗어나는 가장 빠른 방법은 남쪽 개울을 건너는거지(Story Event 3). 자, 이제 갑시다. 앞장 서시오. 난 근처에 숨어 따라가리다!\" 말락은 뒤쪽으로 물러나 수풀 속에 숨어든다."
	},
	{
	...
	},
	{
		...
		ko: "영웅들은 눈을 의심하지 않을 수 없다. 그렘린 무리 가운데 한마리, 번뜩이는 눈과 흉악한 발톱을 가진 놈이 있다. 그 사악한 악의 창조물은 재빠른 움직임으로, 공격을 위한 태세를 갖춘다!"
	},
	{
	...
	},
	{
		...
		ko: "마침내, 영웅들은 문 차일드로 향하는 여정을 계속할 수 있게 되었다.  저주받은 뱀파이어를 찾기 위한 그들의 여정에 다가올 위험을 염려하며..."
	},
	{
		name: "$2.26 (Ending)",
	...
	// QUEST III
	{
		...
		ko: "해답을 찾아, 영웅들은 마르커스와 함께 트윈윔즈의 정남쪽에 위치한 작은 도시인 론 파인으로 향한다. 몇 시간의 여정 후, 일행은 피난민들과 마주친다. 그들은 구원과 도움을 찾는 절박한 마음으로, 론 파인을 탈출해 불멸의 영웅들의 도시로 향하고 있다. 영웅들이 피난민 중 하나에게 질문하자, 그는 저주받은 도시에 대한 이야기를 해준다. \"더 이상 앞으로 가지 마시오. 론 파인은 저주 받았소! 죽은 자들이 무덤에서 일어나, 산자들이 머물 곳이 없소이다. 어리석은 짓 말고 도망치시오!\" 일행이 도시로 다가가자, 더 많은 피난민들이 도로를 가득채우며, 공기에 긴장감이 가득찬다. 침묵속에서 영웅들이 도시의 관문에 도착하자, 중앙 광장 근처에서 울려퍼지는 비명소리가 그들을 반긴다."
	},
	{
	...
	},
	{
		...
		ko: "\"오, 보아하니 당신들은 용병이군요, 그렇죠? 내가 못되게 구는건 맞지만, 당신들은 그런 대우를 받아 마땅해요. 여기 원하던 보상이예요! 더 필요한거 있나요?\""
	},
	{
	...
	},
	{
		...
		ko: "영웅들은 지식과 기술을 총동원하여, 책에 담긴 죽은 자를 조종하는 힘을 제거하려 한다. 검은 불꽃이 책의 모든 페이지를 태우고, 곧 한때 강력했던 유물은 재만 남는다."
	},
	{
		name: "$3.24 (Ending)",
	...
	},
	{
		...
		ko: "일행은 무사히 묘지를 떠나 사원에 도착한다. 영웅들이 사원에 도착하자, 론 파인의 시민들이 그들을 환영하며 감사의 뜻을 전하고, 아서 경은 외친다. \"영웅들이시여. 여러분의 이름은 칭송받아 마땅합니다! 이리오십시오. 여러분의 영웅적인 행동과... 희생된 우리의 친구들을 기릴 시간입니다!\" 축제가 끝나자, 아서 경이 영웅들에게 다가와 말한다. 그의 얼굴은 그늘져있다. \"이제 약속대로 사제께서 여러분께 여행자 애쉬에 대한 이야기를 해주실 시간이 되었군요... 긴 이야기가 될 것 입니다.\" 영웅들은 깜빡이는 촛불빛만이 비추고 있는 작은 방에서 사제를 만난다. 자세를 바로 잡으며, 사제는 이야기를 시작한다. \"사실, 애쉬가 제 정신인 시간은 매우 짧았습니다. 그는 상처로 인한 고열로 혼미한 상태였지요. 하지만, 그의 두서없는 이야기에는 공통된 내용이 있었습니다. 그 누구보다 매혹적인 여인이 문 차일드를 찾아왔다고 합니다. 그녀의 눈동자는 무지갯빛이었고, 진홍색 드레스를 입고 있었으며, 늑대들이 그녀의 곁을 지키고 있었는데, 그 누구도 생전 보지 못했을 정도로 커다란 늑대들이었다고 합니다. 남자, 여자, 심지어 동물들 조차 그녀의 매력에 저항하지 못했고, 애쉬 역시 그녀에게 홀려 그녀의 사악한 행위를 돕게 되었다고 합니다. 저는 고대의 문헌에서 비슷한 내용을 본 적이 있습니다. 그에 따르면 애쉬가 묘사한 여자는 릴리스 입니다. 사령술에 정통한 강력한 고대의 악마지요.  애쉬에 대한 이야기는 여기까지 입니다. 어디까지가 진실이고, 어디까지가 죽어가는 이의 망상인지는 저도 모르겠군요... 하지만 사악한 존재가 그 마수를 뻗고 있는 것은 분명합니다, 저는 문 차일드로 향하는 여러분의 여정이 걱정되는군요. 악의 근원을 쫓으실 생각이라면, 영웅들이시여. 부디 조심하십시오. 지금보다 악의 힘이 강했던 시기는 없었습니다!\" 영웅들이 사원의 홀로 돌아오자, 아서 경이 마지막으로 작별의 인사를 한다. \"애쉬에 대한 이야기가 여러분께 도움이 되었을런지 모르겠군요. 여러모로 여러운 시기이지만, 저는 사람들을 지키기 위해 언제나 최선을 다할 것 입니다. 불행히도, 론 파인은 엄청난 손실을 겪었기에, 여러분께 보상으로 드릴만한 금화는 없습니다. 하지만 여러분이 론 파인을 떠나시기 전에 제 휘하의 무기공과 대장장이들에게 여러분의 무기의 날을 세우고, 갑옷을 강화하라고 명하겠습니다. 용감한 영웅들이시여! 언젠가 우리가 다시 만날 일이 있으면 좋겠군요.\""
	},
	{
		name: "$3.26 (Ending)",
	...
	},
	{
		...
		ko: "문 차일드에 새로운 태양이 밝아온다. 공포와 밤의 괴물들은 떠오르는 태양 빛과 함께 사라진다. 거리는 다시 활기가 넘치고, 피에 굶주린 살인마의 새로운, 잠재적 희생자들 (Shadows) 로 가득찬다. 이제 영웅들이 사냥할 시간이다!"
	},
	{
	...
	},
	{
		...
		ko: "케슬러는 영웅들에게 화를 내며 대답한다, \"내가 두려워했던 일이 벌어졌군. 누군가 혹은 무언가가 인간의 몸에 늑대의 혼을 불어넣는 마술을 찾아냈음이 분명해. 그 마술은 한때 위르겐 왕족들만이 사용하던 고대의 힘이라네. 자연의 힘을 제어하는 것은 보통 사람들에게는 몹시 어려운 일이지, 이 힘은 결국 고대로부터 내려온 혈통을 끝장냈다네. 이 도시 또한 그리되겠지. 사람들은 과거를 잊는다네. 해가 지날때마다 사실은 이야기가 되고,  이야기는 전설이 되지. 자네들은 이제까지 만나본적이 없는 가장 공포스러운 짐승을 마주하게 될 걸세. 늑대의 혼을 품을 가치가 없는 자들 말이지. 그들은 그 때문에 타락하게 될걸세. 그들이 한때 인간이었다고 해서 동정심을 갖지 말게나, 놈들 역시 그러할리 없으니! 오, 내가 다시 한 번 상대할만한 적을 만나게 될 줄은 몰랐군. 난 자네들과 함께 싸울수는 없지만, 도움이 될만한 일을 해주지. 자네들의 무기 중 하나를 내가 주게나, 아니면 내 무기 중 하나를 가져가도 좋네. 내가 그 무기를 수은을 주입해주지. 이것을 사용하게 될 줄은 몰랐군. 이 힘은 오래가지 않는다네, 하지만 그 짐승들을 상대하기엔 충분할테지. 우리는 다시 만나게 될걸세, 자네들의 살아남을 가치가 있음을 증명한다면 말일세!\""
	},
	{
		...
		ko: "무시무시한 울부짖음, 그리고 그에 이어지는 비명소리와 시청의 종소리가 마지막 전투의 시작을 알린다. 흰 털와 붉은 눈을 가진 거대한 우두머리가 이끄는 늑대인간 무리가 시청을 포위하고 있다. 영웅들이 다가가자, 놈들은 영웅들을 향해 돌아선다. 타오르는 불과 퍼져가는 연기를 보며 영웅들은 시간이 얼마 남지 않았음을 깨닫는다."
	},
	{
		name: "$4.47 (Ending)",
		...
		ko: "영웅들의 승리로 연쇄 살인 사건은 막을 내린다. 그리고 또한 이 승리는 경비병들에게 포위 공격에 맞설 충분한 용기를 준다. 악몽이 사라진 첫번째 밤이 지난 뒤, 시장은 일행을 시청으로 호출한다. 크레인 경감을 포함한, 문차일드의 중요 인사들이 참석한 축하연이 벌어진다. 뻔한 내용의 연설이 끝난 뒤, 빅터는 영웅들에게 이야기한다. \"영웅들이여. 어떤 말로도 여러분의 업적을 충분히 기릴 수 없습니다, 그렇기에, 문차일드는 여러분께 우리 도시의 가장 중요한 유물 중 하나를 드리기로 했습니다!\" 이 말이 끝나자, 이고는 그의 왼쪽 다리를 조금 절며, 장식함을 열어, 귀한 무기를 선보인다. 그리고 빅터가 말을 이어간다. \"부디 이 무기가 여러분이 달브 백작을 물리치는데 도움이 되길 바랍니다!  소문에 의하면 벌낫(Scythe) 호수 남서쪽 바위 지대에 하룻밤만에 음침한 성이 나타났다고 합니다. 전 그곳에 달브 백작이 있으리라 장담합니다. 여기에 그 지역에 대한 가장 상세한 지도가 있습니다. 그리고 우리의 정찰병이 여러분께 그곳으로 통하는 가장 안전한 길을 알려드릴 겁니다. 탈론 코스트를 위해, 여러분의 성공을 빕니다. 아직 빛나고 있는 희망이 있다면, 그건 바로 여러분 안에 있을겁니다! 안녕히 가십시오, 고귀한 영웅들이여!\" 영웅들은 문차일드를 떠나 도시 성문 밖으로 나온 직후, 케슬러와 마주친다. \"자네들은 이 저주받은 도시를 구원하여 자신의 영혼의 강함을 증명했네. 친구들이여. 이것을 받게. 자네들이 물리친 흰 털을 가진 늑대인간, 코비너스의 심장일세. 나는 이를 이용해 올바른 방식으로 늑대의 영혼을 소환할 수 있지. 그건 바로 내가 애덤 케슬러 위르겐, 사라져가는 위르겐 왕가의 마지막 후손이기 때문이지. 나는 오랜 세월 이런 기회를 기다려왔지, 하지만 내게는 너무 늦었다네. 지금 내게는 말이지. 하지만 자네들에게는... 아직 이 능력을 받아들일 시간이 있지. 하지만 자네들 중 단 한 명, 가장 순수한 심장을 가진 자 만이 이 시련에 도전할 수 있다네. 그리고 그가 자신을 증명한다면, 그는 이 땅에서 가장 야성적이고 강력한 포식자로 변할 수 있을걸세!\""
	},
	{
		name: "$4.48 (Ending)",
		en: "Defeat burns as white flame, searing the hearts of the heroes...",
		ko: "패배는 하얀 불꽃처럼 타올라, 영웅들의 심장을 태운다..."
	},
	{
		name: "$4.49 (Ending)",
		...
		ko: "늑대인간과 그들의 패거리가 시청을 파괴하는데 성공하고, 문차일드의 심장이 되는 건물은 화염에 휩싸여 불타오른다. 시청이 울부짖는 불꽃 속에서 무너져내리는 동안, 그 안에 있던 빅터 시장과 크레인 경감은 타오르는 불지옥 속에서 죽음을 맞이한다. 대부분의 건물이 파괴된 문차일드는 이제 의심할 여지 없이 걸어다니는 시체들에 의해 짖밟히게 될 것이다. 영웅들이 할 수 있는 일이라고는 자신들의 목숨을 건져, 남쪽으로 전진하는 것 뿐이다. 복수심이 그들의 가슴 속 깊은 곳을 태운다. 달브 백작은 희생된 사람, 한 명, 한 명마다 그 대가를 치르게 될 것이다!"
	},
	{
		name: "$4.51 (Ending)",
		...
		ko: "그 모든 희생은 영웅들을 비탄에 빠뜨리지만, 그들의 영혼을 구속하는 주문을 깨뜨리려는 영웅들의 의지는 그 무엇보다 강하다. 일행은 문차일드를 구원하고 달브 백작을 완전히 제거하기로 결심하고, 수사를 다시 시작한다."
	},
	{
		name: "$4.52 (Ending)",
		...
		ko: "당신의 영혼의 정수는 그 짐승의 힘을 지배하려 한다. 당신은 짧지만 격렬한, 한바탕의 고통을 느낀 후, 그 자연의 힘은 지배될 수 없다는 것을 깨닫는다. 케슬러는 영웅이 바닥에 쓰러지는 것을 본 뒤 돌아서며, 슬픔에 잠긴 목소리로 가혹한 진실을 이야기한다.  \"자네는 자연의 정수를 지배하려 했군. 그 누구도 그럴 순 없지. 늑대의 영혼은 자네를 떠났네. 다시는 돌아오지 않겠지. 잘 가게나.\""
	},
	{
		name: "$4.53 (Ending)",
		...
		ko: "당신의 영혼은 늑대의 그것과 완벽히 조화를 이룬다. 당신의 몸에 전율이 흐른 뒤, 당신은 당신의 혈관에 흐르는 힘을 느낀다. 밤하늘의 달, 그 자체와도 같은 거칠고 강력한 힘을. 케슬러는 늑대의 영혼이 이 세계로 돌아온 것을 느끼고는, 등을 돌려 발걸음을 옮긴다. 하지만 당신의 귀에, 그의 남기는 마지막 말이 들려온다. \"자네는 자연의 정수를 받아들였네. 자랑스러워 해도 좋아. 늑대의 영혼은 오직 그럴 자격이 있는 이만을 선택하니까 말이야. 자네는 이제 강력한 동료를 얻었다네. 잘 가게나.\""
	},
	{},
	...
	// QUEST V
	{
		...
		ko: "일행은 벌낫(Scythe) 호수 근처에 위치한, 달브 백작의 성을 향해 여행한다. 불사의 군대가 문차일드를 향해 진군을 시작했지만, 영웅들은 들키지 않고 그 옆을 지나친다. 바다와 이어지는 가파른 절벽 위에 세워진 작은 성, 그 성은 별이 빛나는 밤하늘 아래, 마치 정체를 숨긴 악처럼 그 윤곽만을 드러낸다. 어두운 구름으로 만들어진 두터운 장막이 그 성을 감싸, 마치 그곳만 홀로, 다른 세상에 있는 것 처럼 보이게한다. 마커스는 장막에 진입하기 전 일행을 멈춰세우고는 이야기한다. \"곧 새벽이 밝아올겁니다, 하지만 이 구름이, 흡혈귀 백작을 상대로 우리의 가장 강력한 아군이 되어줄 이를 가로막고 있습니다. 바로 태양 말이지요!  저는 성 안에서는 어떤 도움도 드릴 수 없을겁니다. 하지만 지금 여기서 - 신들의 힘을 빌어 - 이 곳을 둘러싼 주술을 약화시켜 보겠습니다. 제가 이 일에 성공하면, 여러분께 알려 드리겠습니다. 세분의 신께서 여러분께 승리를 가져다 주시길!\" 그리하여, 영웅들은 문을 향해 전진한다. 안에서는 오직 침묵만이 영웅들을 맞이한다. 죽음은 소리를 내지 않기에..."
	},
	{
		name: "$5.1 (Waypoint 1)",
	...
	},
	{
		...
		ko: "미궁의 영원한 어둠이 승리했다. 그 어둠은 영웅들의 생명의 불꽃을 꺼뜨린다. 트윈 윔즈의 영웅들은 패배하여 이 이름 없는 미로를 영원히 헤매이는 유령이 된다.",
	},
        {},
