var data_swordandsorcery_darknessfalls = [
		...
		},
		{
                ...
                },
                {
                        ...
                        ko: "높은 고딕 양식의 창문에서 새까맣게 타오르는 태양 광선이 그 궁궐로 들어왔다. 그들 중 한 명은 뱀파이어의 피부를 어루만지며, 이 생물로부터 고통의 비명을 이끌어낸다! 빛이 두려워서, 그는 손을 흔들고, 여러 명의 궁궐 수비대들에게 샹 마법을 걸어, 그들을 군중을 향해 돌리게 한다. 그는 그늘진 망토로 몸을 감싸고 안개 속으로 빠져들면서 궁궐 지하감옥 쪽으로 사라졌다. 몇 번의 시도 끝에, 마르쿠스 목사는 궁궐 문을 열었고 손님들은 목숨을 걸고 도망칠 수 있었다. 그리고 나서, 그는 영웅들에게로 돌아간다. \"도시를 떠나기 전에 빨간 머리의 여자를 찾아야 해. 그녀는 달브 백작에 대해 더 많은 정보를 가지고 있을 것이다.\""
                },
                {
                        ...
                        ko: "괴상한 소리가 남쪽에서 날아오는 이상한 생명체들을 알려준다. 관능적이지만 사악한 날개 달린 여성들이 도시 상공으로 날아오르면서 어둠의 기운이 감돌았다. 그들이 노래를 멈추자마자, 매혹된 경비원들은 인근 시민들과 함께 죽었다. 곧, 그들의 시체는 뒤틀린 마법에 의해 되살아나고, 살아있는 사람들에 대한 공격을 시작한다!"
                },
                {
                        name: "$1.17 (Event 4)",
                        ...
                        ko: "도시를 사로잡고 있는 혼란과 두려움 속에서 영웅들은 그녀가 군중 속으로 사라지려고 할 때 그럭저럭 그 여자를 찾는다. 이미 적들과 전투에 임한 영웅들은 마르쿠스와 그의 전사 제사장들에게 싸움이 끝날 때까지 그 여자를 구금하라고 신호를 보낸다."
                },
                {
                ...
                },
                {
                        ...
                        ko: "영웅들은 붉은 머리의 여자에게 관심을 돌린다. 그 여자는 \"내 이름은 칼립소고, 나는... 잭 크로우의 친구 그는 네게 그의 도시를 지켜준 것에 대한 인사와 감사를 보낸다. 이건 그의 선물이야... 이제 당신은 당신의 진정한 적을 알게 되었다. 아, 그리고 그는 나에게 이 두루마리를 주라고 했어, 그럴 만하면. 자, 이제 작별을 고한다!\"그녀의 갑작스러운 손놀림으로, 그 여자는 부적을 울리고 검고 매캐한 연기 속에서 사라진다. 화가 난 영웅들은 단지 두루마리만 읽을 수 있다. \"친구들, 나는 너무 잘 알고 있다. 나는 우리의 어둡고 위압적인 숫자에 날을 묶지 않을 수 없다. 오직 내가 너를 묶는 마법을 지배할 수만 있다면 말이다! - 그럼 이 선물을 하나 드리자면, 남쪽의 달 어린이들을 찾아라. 만약 그들이 당신을 먹지 않는다면, 당신은 친구가 될 수도 있다. 추신. 내가 너라면 론 파인 마을을 피했을 텐데. 요즘 숲은 도시보다 훨씬 안전한 것 같다.영웅들은 마르쿠스가 관찰한 것처럼 탈론해안의 지도를 본다. \"아마도 문어린이 시를 언급했을 것이다. 하지만 나는 그곳의 주민들이 먹을 수 있는 어떤 위협도 전혀 모른다. 마르쿠스는 숨을 쉬다가 계속된다. 우리는 그곳에서 달브에 대한 단서를 찾을 수 있을지 모르겠다. 그러나 숙큐비는 남쪽에서 왔기 때문에 남쪽에서 시작해야 한다.그래서 영웅들이 다시 이동한다."
                },
                {
                        name: "$1.20 (Ending)",
                ...
                },
                {
                        ...
                        ko: "죽지 않은 자들은 영웅들의 몸과 영혼을 모두 먹어치운다... 시대를 초월한 악마는 탈론 해안에 쓰레기를 버릴 것이다."
                },
		{
