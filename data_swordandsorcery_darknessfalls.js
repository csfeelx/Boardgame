var data_swordandsorcery_darknessfalls = [
		...
		},
		{
                ...
                },
                {
                        ...
                        ko: "새벽이 되어 막 떠오르는 태양빛이 고딕 양식의 창문을 통해 궁전으로 쏟아져 들어왔다. 빛줄기 중 하나가 뱀파이어의 피부를 어루만져 그에게서 고통스러운 비명을 이끌어냈다. 아침이 된 것에 겁을 먹은 그는 손을 흔들어 몇명의 궁전 호위병에게 주문을 걸어 그들이 군중들을 공격하게 만들었다. 그는 그의 그늘진 망토로 몸을 감싸고 안개 속으로 스며들어 궁전의 지하 감옥 방향으로 사라졌다. 성직자 마르커스는 몇 번의 시도 끝에 궁전의 문을 열어, 손님들을 피난시킬 수 있었다. 그 후 그는 당신에게 돌아서 말했다. \"우리는 붉은 머리의 여자가 도시를 빠져나가기 전에 그녀를 찾아야 합니다. 그녀는 달브 백작에 대해 더 알고 있는 것이 있을겁니다!\""
                },
                {
                        ...
                        ko: "기이한 소리와 함께 남쪽에서 이상한 괴물들이 날아오는 것이 보였다. 관능적인 외모를 하고 있지만 악마의 날개를 단 여성들이 도시 상공위로 날아다니며, 어둠의 주문을 외우고 있었다. 곧 그녀들은 노래를 멈추었고, 주문에 걸린 경비병들와 그들이 지키던 시민들은 죽음을 맞이했다. 그리고 그 순간, 그들의 시체가 다시 일어나, 뒤들린 마법에 조종당해, 살아있는 것들을 공격하기 시작했다!"
                },
                {
                        name: "$1.17 (Event 4)",
                        ...
                        ko: "혼돈과 공포로 뒤덮힌 도시에서, 영웅들은 군중 속으로 사라지려던 붉은 머리의 여자를 찾아냈다. 적들과 전투 중인 영웅들은 마르커스와 그의 전투 사제들에게 싸움이 끝날 때 까지 그녀를 구금하라고 신호를 보냈다."
                },
                {
                        ...
                        ko: "전투 사제와 민병들의 도움으로, 영웅들은 스큐비와 불사의 해골들의 공격을 가까스로 막아냈다. 하지만 도시를 사로잡은 공포는 쉽게 사라지지 않을 것이다. 달브의 정체가 밝혀짐에 따라, 최근에 벌어진 일련의 사건들을 다른 시각으로 볼 수 있었다. 분명한 것은 그림자 길드가 두려워 하던 것은 바로 달브였다는 것이다! 복수의 대한 갈망과 그들의 영혼을 붙들고 있는 주문에서의 해방을 바라며, 불멸의 영혼들은 뱀파이어 백작을 쫓기위한 준비를 시작했다."
                },
                {
                        name: "$1.19 (Ending)",
                        ...
                        ko: "영웅들은 붉은 머리의 여자에게 관심을 돌렸다. 그녀는 자신을 이렇게 소개했다. \"내 이름은 칼립소, 난 잭 크로우의 친구야. 그는 당신에게 그의 도시를 지켜준것에 대한 감사를 전해달라고 했어. 이건 그의 선물이야... 이제 당신의 진정한 적이 누군지 알겠지? 아, 그는 내게 당신에게 이 두루마리를 전하라고도 했어, 당신이 받을 자격이 있다면 말이지. 그럼 작별이야!\  그녀는 재빠른 손놀림으로 부적을 가동시켰고, 검고 매캐한 연기속으로 사라졌다. 영웅들은 화가 났지만, 두루마리를 읽을 수 밖에 없었다. \"친구들에게, 나는 너희가 나를 돕지는 않겠지만, 사악하고 위압적인 백작에게 칼을 들이댈 것이라는 것을 잘 알고 있었지. - 내가 너희를 묶어두고 있는 주문을 지배할 수만 있다면! - 그래서, 선물을 하나 주고 싶군. 한 마디의 조언일 뿐이지만. 남쪽에서 깊은 곳에서 달의 아이들을 찾아봐. 그들이 너희를 잡아 먹지 않는다면, 친구가 될 수 있을지도 모르지. 추신. 만약 나라면 론 파인 마을은 피할거야. 요즘 시기에는 숲이 도시보다 안전하니 말이야.\" 영웅들은 마르커스와 함께 탈론 코스트의 지도를 살펴 보았다. \"아마도 문차일드 도시를 말한 것 같습니다만, 하지만 난 이 곳 주민들이 사람을 잡아 먹는 다는 이야기는 들어 본적이 없군요...\" 마르커스는 잠시 말을 멈추고 호흡을 고른 후 이야기를 계속했다. \"우리가 그 곳에서 달브에 대한 단서를 얻을 수 있을지는 모르겠지만, 어쨋든 서큐비가 남쪽에서 왔으니, 우선 남쪽에서 부터 찾아보는게 좋을 것 같군요.\" 그리하여 영웅들은 그들의 여정을 계속했다."
                },
                {
                        name: "$1.20 (Ending)",
                        ...
                        ko: "그들의 노력에도 불구하고, 영웅들은 그 불타는 머리 여자의 흔적을 찾을 수 없다. 잠시 후, 그들은 그 여자가 도시를 떠났다는 것을 인정해야만 한다. 더 이상의 단서가 없으면, 그 당은 마르쿠스로 변한다. 사원에서 다른 성직자들과 짧은 대화를 나눈 후 마커스는 남쪽에 위치한 론 파인이라는 도시에서 오늘 아침 까마귀가 도착하는 영웅들에게 말한다. 그 새는 \"Evil이 우리 도시에서 깨어났다! 사랑하는 이들을 죽이기 위해 무덤에서 죽은 자들이 솟아나오! 당신은 트윈 와임스의 영웅이거나, 또는 군이 노래를 부르므로, 우리는 당신의 도움을 청한다. 제발, 우리를 도우러 오렴!\" 마르쿠스는 \"우리는 우리가 그곳에서 달브에 대해 어떤 단서도 찾을 수 있을지 모르겠다. 그러나 숙큐비는 남쪽에서 왔기 때문에 남쪽에서 시작해야 한다.\”"
                },
                {
                        name: "$1.21 (Ending)",
                        en: "The undead devour both the bodies and souls of the heroes... A timeless Evil will lay waste to the Talon Coast.",
                        ko: "죽지 않은 자들은 영웅들의 몸과 영혼을 모두 먹어치운다... 시대를 초월한 악마는 탈론 코스트에 쓰레기를 버릴 것이다."
                },
		{
