        ...
        },
{
        ...
        ko: ""
},
                {
                        ...
                        ko: "\"그 모든 것이 며칠 전에 시작되었다. 애쉬라는 이름의 여행자가 론 파인에 들어왔다. 그는 건장한 사람이었지만 중상을 입었다 그는 우리에게 문차일드로부터 온다고 말했는데, 그는 넋이 나간 다음 남로에서 악마에게 공격을 받은 적이 있었다. 우리는 그 이야기를 죽어가는 사람의 열광적인 정신착란이라고 비웃었다. 사실 애쉬는 조금 늦게 죽었지만, 우리 성직자와 개인적으로 이야기를 나누기 전에는 죽지 않았다. 우리는 그의 경고의 말을 거의 기억하지 못한 채 그 불행한 낯선 사람을 묻었다. 아아, 그 다음날 밤 묘지는 저주를 받았다. 죽은 사람들은 그들의 무덤에서 살아났다. 처음에는 1과 2로 나뉘었지만, 그 다음에는 몸뚱이와 표백된 해골들이 모두 생겨났다. 진실로 죽지 않은 군대가 우리 집 문간에 집결하여, 곧 우리는 길을 막고 이 신전으로 피신할 수밖에 없었다. 제발, 영웅들아, 다시 우리를 도와줘. 묘지를 저주에서 해방시켜라. 그러면 우리는 너희를 지지할 것이며, 애쉬의 이야기를 들려줄 것이다. 아마도 그것은 당신의 탐구에 도움이 될 것이다. 성전 안에서 우리의 현명한 성직자를 찾아라(웨이포인트 3) 그러면 그가 당신에게 안내를 해줄 것이다.\""
                },
                {
                        name: "$3.7 (Waypoint 1)",
                ...
                },
                {
                        ...
                        ko: "일행은 지하실을 나와 더 이상 마주치지 않고 절에 닿는다. 영웅들이 신전에 이르자, 론 파인 사람들은 감사를 표하고, 아서 경은 \"당신의 명성은 마땅히 받을 만하오, 모험가여! 어서! 이제 네 행위를 칭찬할 때가 되었구나... 그리고 우리의 추락!\" 잔치가 끝나면 아서 경은 얼굴에 그림자가 드리운 영웅들에게 시선을 돌린다. \"이제 내 현명한 성직자가 당신에게 여행자 애쉬의 이야기를 들려줄 때가 된 것 같군... 아무리 간단히 말해도...\"영웅들은 깜박이는 촛불에 불이 켜진 작은 방에서 성직자를 찾는다. 입술을 적시고 남자가 말하기 시작한다. \"사실 애쉬는 정신이 번쩍 드는 순간이 거의 없었다. 그의 상처는 그를 정신없게 만들었지만, 모든 열띤 담소에는 이런 공통점이 있었다. 탈론 코스트의 가장 매력적인 아가씨는 무지개빛 눈과 주홍색 드레스를 입은 여자로서, 이전에 어떤 남자보다 더 큰 거대한 늑대들과 함께 걷고 있었다. 남자든 여자든 짐승이든 그녀의 매력에 저항할 수 있는 생물은 없다. 나도 넋이 나갔고, 그녀는 나를 자신의 어두운 행위로 이용했다. 이것은 내게 애쉬의 말이었고, 고대 유물에 대한 나의 지식으로 보아 나는 이 여자를 알고 있다. 애쉬는 고대인이자 강력한 악마인 릴리스를 묘사했고, 신령술에 정통했다. 그 모든 일이 있은 후, 나는 어느 부분이 사실일 수 있고 어느 부분이 정신나간 상상력의 산물일 뿐인지 알 수 없다... 하지만, 악은 거미줄을 치고 있어. 그리고 네가 조사하고 싶다면, 문차일드에게 가는 길이 두려울 뿐이야. 조심해라, 영웅들아! 악이 이렇게 강력한 적은 없었어!\" 영웅들은 복도로 돌아가고, 아서 경은 마지막으로 그들에게 연설한다. \"이 이야기가 당신에게 도움이 될지 모르겠지만, 지금은 힘든 시기야, 그리고 나는 항상 내 사람들을 보호하기 위해 최선을 다할 거야. 불행하게도, 우리는 엄청난 손실을 입었고, 당신에게 줄 금은 없지만, 나의 대장장이들과 보우어들은 당신이 론 파인을 떠나기 전에 당신의 무기를 갈고 당신의 갑옷을 강화할 것이다. 언젠가 우리가 다시 만났으면 좋겠어, 용감한 영웅들!\""
                },
                {
                        name: "$3.26 (Ending)",
