var data_folklore = [
	...
	},
	{
		...
		item: [
			...
			"<br/> ...<br/><br/> 관리인은 당신이 강도들을 쫓아내고 교회의 물건을 도둑맞지 않도록 해준 것에 감사를 표한다. 그는 이 지역에 불미스러운 일들이 생기기 시작했으며, 북쪽에는 훨씬 더 심한 재앙이 닥치고 있다고 말한다.<br/><br/> 그가 이야기한다, \"며칠 전 이것이 교회에 도착했다오. 사제께선 그 즉시 조사를 위해 떠나셨지!\" 그는 경고도 없이 테이블 위에 있던 덮개를 들어 올려 피투성이가 된 털투성이의 사체를 보여준다.<br/><br/><br/> <b>STORY SKILL CHECK<br/>NERVE 4</b> - All Characters<br/><br/> <b>토할 것 같은 기분을 억눌러라!</b><br/><br/> ",
			{
	...
	},
	{
		...
		item: [
			...
			"<br/> ...<br/><br/> <b>AFTER THE FIGHT</b><br/><br/> 늑대들을 처리한 뒤, 농부가 당신에게 이야기한다. \"이쪽으로 가면 오래된 묘지가 나옵니다. 그곳에 있는 영묘(mausoleum)에 누리안의 동굴으로 들어가는 잊혀진 입구가 있습지요... 사제님께선 그곳으로 가셨습니다.\" 그는 당신과 함께하며 길을 안내해주겠다고 한다. The Leader gains the Farmer Companion.<br/><br/> ..."
		]
	},
	{
		name: "INTO THE HOLLOW (7~8): 동굴을 향해",
		item: [
			"당신은 오래된 묘지에 들어선다. 곧 누리안의 동굴과 이어져 있다는 영묘가 모습을 드러낸다. 왼쪽에는 파헤쳐진 무덤이 있다. 당신은 동굴로 이어지는 입구를 찾기 바라며 서둘러 영묘 지하로 내려가는 문으로 향해 나아간다.<br/><br/> ...<br/><br/> <b>MAP SKILL CHECK 2<br/>TRICKERY 7</b> - Any Character During Their Turn<br/><br/> <b>영묘로 들어가는 문을 열 수 있는가?</b><br/><br/>",
			{
			...
			"<br/> ...<br/><br/><b>MAP SKILL CHECK 1<br/>AWARENESS 6</b> - Any One Character<br/><br/> <b>특이한 점을 눈치챈 것이 있는가?</b><br/><br/>",
			{
				name: "<b>성공</b>",
				item: [
	...
	},
	{
		...
		item: [
			...
			"<br/>...<br/><br/><b>OPTIONAL GOALS</b><br/><br/> <b> • 사제가 죽기 전에 그를 구출하라(completing this map skill check). YOU HAVE ONLY 6 ROUNDS.</b><br/><br/> <b>MAP SKILL CHECK<br/>TRICKERY 6</b> - 사제를 구출하기 전까지 ANY CHARACTER<br/><br/> <b>사제에게는 남은 시간이 얼마 없다. 당신은 서둘러 그를 구해내야 한다.</b><br/><br/> ",
			{
	...
	},
	{
		...
		item: [
			"당신은 사제가 말한 현자를 찾기 위한 여정을 시작한다. 그녀는 웨일린 포인트 변두리 어딘가에 있다.<br/><br/> <b>WORLD MAP</b><br/><br/> To find the wise woman's location, place 4 Compass tokens (labeled A thru D) randomly in the locations shown on the map to the right. Whenever you land on an Off-Road map area with a marker, flip it over read the associated Story Moment. If you decide to stop your search, you may skip foward to <b>\"A Town In Need (Choice Two)\" on page 11.</b><br/><br/>",
			{
				name: "A",
				item: [
	...
	},
	{
		...
		item: [
			"웨일린 포인트를 찾아가 환자들을 조사해야 할 때이다. 아마도 누군가는 역병에 대한 정보를 가지고 있을지도 모른다.<br/><br/> ...<br/><br/> 웨일린 포인트의 사람들은 깊은 절망에 빠져있다. 당신이 의사가 어디에 있는지를 묻자, 주민 하나가 당신을 마을 회관으로 안내한다. 마을 회관은 넘치는 환자들을 위한 진료소로 바뀌어 있다. 마을 회관으로 들어서자, 그곳에는 일렬로 늘어선 병상과 그 위에 누워있는 환자들이 보인다. 환자들은 고열에 시달리고 있으며, 그들의 피부는 종기로 뒤덮여 있다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>당신은 환자들을 살펴보겠는가, 아니면 서둘러 의사를 찾겠는가?</b><br/><br/>",
			{
	...
	},
	{
		...
		item: [
			"다큰바우 숲에 발을 들이자 당신의 피부가 따끔거린다. 당신은 숲 속의 공기에서 섬뜩한 기운을 느낄 수 있다. 그것은 당신을 부르고, 당신을 발걸음을 재촉하며, 당신을 망각으로 이끈다. 당신은 불안함을 떨치고 숲 속 깊은 곳으로 발을 내딛는다. 숲 어디에나 부패의 징후가 역력하다. 당신은 나무들이 기이한 패턴을 그리며 자라나 있는 것을 눈치챈다. 그 모양은 마치 룬 문자로 절망의 뜻이 담긴 고대의 단어를 그리고 있는 듯하다. 길이 좁아지고 두꺼운 잎사귀들이 지붕을 이루어 햇빛을 차단한다. 당신의 앞에 놓인 어둠 속에, 무언가의 윤곽이 보인다. 당신은 간신히 그것이 돌로 만들어진 고대의 아치문임을 눈치챈다.<br/><br/> ...<br/><br/> <b>OPTIONAL GOALS</b><br/><br/> <b>• Investigate all search locations.</b><br/><br/> <b>• Investigate the archway by completing this map skill check.</b><br/><br/> <b>MAP SKILL CHECK<br/>ARCHEOLOGY 6</b> - Any One Character<br/><br/> <b>작은 공터에 돌로 만들어진 고대의 아치문이 서 있다. 그 표면은 고대 문자로 뒤덮여있다. 그것을 자세히 살펴보자 이전에는 본 적 없었던 패턴이 보이기 시작한다.<br/>당신은 그 뜻을 알겠는가?</b><br/><br/>",
			{
				name: "<b>성공</b>",
				item: [
	...
	},
	{
		...
		item: [
			...
			"<br/>당신이 끔찍한 흉물을 향해 마지막 일격을 날리자 그 사악한 나무는 결국 쓰러지고 만다. 당신은 승리를 만끽하지만, 곧 놈의 거대한 입을 통해 맥동하는 보라색 빛이 떠오른다. 놈의 입은 마치 땅속으로 들어가는 터널처럼 보인다. 당신은 사건이 아직 끝나지 않았다는 것을 알고 있다. 당신은 저 안으로 들어가 그 안에 숨겨진 비밀을 밝혀야만 한다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>당신은 거대한 참나무의 높다란 가지 위에서 무언가가 반짝이는 것을 눈치챈다. 가지 위로 올라가 그것이 무엇인지 살펴보겠는가?</b><br/><br/>",
			{
	...
	},
	{
		...
		item: [
			"다큰바우 숲에 역병을 뿌리던 거대한 참나무는 이제 파괴되었다. 하지만 그 힘의 원천은 여전히 남아있다. 선택지는 하나뿐이다. 당신은 놈의 입을 통해 지하로 들어가야만 한다. 당신이 틈을 향해 다가가자, 그 삐죽삐죽한 나무껍질에 끈적한 액체가 묻어있는 것이 보인다.<br/><br/> ...<br/><br/> <b>STORY SKILL CHECK<br/>NERVE 5</b> - All Characters<br/><br/> <b>날카로운 이빨에 주의하며, 당신은 어쩔 수 없이 죽은 나무의 입속으로 발을 들인다.</b><br/><br/>",
			{
