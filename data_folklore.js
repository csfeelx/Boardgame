var data_folklore = [
	...
	},
	{
		...
		ko: "우리의 귀에 희미한 신음이 들려왔다. 곧 그 소리는 귀가 아플 정도로 커졌다. 붉게 타오르는 눈을 가진 희미한 영체가 우리의 눈앞에 나타났다.<br/><br/>Skirmish with a Poltergeist."
	},
	{
	...
	},
	{
		...
		ko: "우리가 길 위를 걷고 있을 때 마을 사람 몇 명이 다가왔다. 그들과 가까워지자 우리는 그들의 피부가 매우 창백하고, 목에는 생긴 지 얼마 되지 않는 물린 자국이 남아있는 것을 눈치챘다. 이 흡혈귀가 된 지 얼마 되지 않은 자들은 지독한 굶주림을 참지 못하고 우리를 공격해 왔다.<br/><br/>Skirmish with Vampires."
	},
	{
	...
	},
	{
		...
		ko: "신선한 피를 노리고 하늘에서 사나운 박쥐떼가 습격해왔다.<br/><br/>Skirmish with a Bat Swarm."
	},
	{
	...
	},
	{
		...
		ko: "우리는 지역 농부들을 위해 왕진을 나와 있던 의사와 마주쳤다.<br/><br/>The group may take advantage of the services of the Physician as if in town."
	},
	{
	...
	},
	{
		...
		ko: "우리는 여행 중인 집시 캐러밴을 방문했다. 그곳에는 여러 가지 일을 하고 있는 다양한 색의 옷을 입은 사람들이 있었다.<br/><br/>Any character holding a Tarot card may discard it and re-draw from the Tarot deck."
	},
	{
	...
	},
	{
		...
		ko: "우리는 길가에 버려진 배낭을 발견했다. 그 안에는 낡고 망가진 책이 있었고, 몇 장 정도는 그 내용을 알아볼 수 있었다.<br/><br/>The Leader receives their choice of a Prayer or Ritual."
	},
	{
	...
	},
	{
		...
		ko: "우리는 길에서 멀지 않은 곳에 있는 버려진 야영지를 발견했다. 그곳은 휴식을 취하기에 아주 좋은 장소로 보였다.<br/><br/>The group recovers 4 Vita, 4 Ghost Points and 4 Power Points."
	},
	{
	...
	},
	{
		...
		ko: "수염을 기른 한 남자가 다가와 멀지 않은 곳에 흡혈귀 무리가 있다며, 그 목에 걸린 현상금에 관심이 없는지 물었다.<br/><br/>If you accept, skirmish with Vampires with their skirmish counter at maximum. He gives you each 25 Coins as an additional award."
	},
	{
		name: "RE#FC23 DAY - MISFORTUNE: 불운",
		ko: "제대로 돌아가는 일이 하나도 없다. 마치 행운의 여신이 나를 버린 것만 같은 기분이다.<br/><br/>The Leader loses all positive statuses."
	},
	{
		name: "RE#FC23 NIGHT - FEARFUL FLIGHT: 겁에 질려 달아나다",
		ko: "춥고 어두운 밤길을 여행하는 것은 우리의 조력자들을 견딜 수 없을 정도로 겁에 질리게 하였다.<br/><br/>One random Militia Companion within the group 은 생명의 위협을 느끼고 근처의 마을로 도망쳐 버리고 말았다."
	},
	{
	...
	},
	{
		...
		ko: "우리는 길가에서 흉악한 짐승에게 살해당한 것으로 보이는 시체 한 구를 발견했다.<br/><br/>One character may perform a search check on the body to gain an Item."
	},
	{
	...
	},
	{
		...
		ko: "다양한 동물을 팔고 있는 한 상인이 자신이 팔고 있는 동물들을 보여주었다.<br/><br/>The Leader may buy one Animal Companion for 25 Coins. You may receive a trained one (as with Stables in town) for an additional 10 Coins."
	},
	{
		name: "RE#FC30 DAY - THE FOREST LIVES: 숲의 생물들",
		ko: "무시무시한 나뭇가지들이 우리의 앞길을 막았다. 성난 나무들이 뿌리를 뽑아들고 움직이며 침입자들을 공격했다... 바로 우리를!<br/><br/>Skirmish with a Dark Oak."
	},
	{
		name: "RE#FC30 NIGHT - HEIROPHANT: 고위 사제",
		ko: "우리는 여행 중인 치유사 한 명과 마주쳤다. 그는 우리에게 호의를 보이며 도움을 주겠다고 했다.<br/><br/>Remove one negative status or heal 1d6 Vita for one character free of charge."
	},
	{
	...
	},
	{
		...
		ko: "우리는 길을 걷다 시체 한 구를 발견했다. 갑자기 시체가 눈을 떴고 새까만 눈이 드러났다.<br/><br/>Skirmish with a Possessed."
	},
	{
		name: "RE#FC33 DAY - TINKER: 땜장이",
		ko: "우리는 대장간이 딸린 농장에 도착했다. 전직 땜장이였던 농부는 우리가 원한다면 일을 해주겠다고 했다.<br/><br/>The group may take advantage of the same services as the Tinker in town."
	},
	{
	...
	},
	{
		...
		ko: "우리는 무기 상인과 마주쳤다. 그는 원한다면 자신의 상품을 보여주겠다고 했다.<br/><br/>The Leader may pay 5 Coins to draw the top 5 cards from the Item deck. You may purchase any weapons there. If you pay double the cost of the weapon, he sharpens it giving that weapon a permanent +1 Damage."
	},
	{
	...
	},
	{
		...
		ko: "우리는 오랜 세월을 살아오며 온갖 분야의 지식과 기술에 통달한 노인과 마주쳤다. 그는 고대 지식의 편린을 나누어주었다.<br/><br/>The Leader gains 1 Ability Point. If a character receives this card more than once in their life, immediately discard it and draw again."
	},
	{
	...
	},
	{
		...
		ko: "농작물들이 시들어버렸고 기근이 이 땅을 덮쳤다. 우리의 궁극적인 목적은 사람들을 돕는 것이다. 할 수 있는 모든 것을 해야 한다.<br/><br/>The group must donate 30 Coins. You may give Items to reach the requirement at half their cost. If you cannot meet this condition, everyone loses all positive statuses and Companions."
	},
	{
	...
	},
	{
		...
		ko: "우리는 여러 마리의 사슴 사체를 끌고 가고 있는 두 명의 사냥꾼과 마주쳤다. 그들은 자신의 전리품들을 근처의 마을까지 운반하는 일에 우리의 도움을 요청했다.<br/><br/>The group may take them as Mission Companions (each fills a companion slot) and bring them to a town to gain 15 Coins each."
	},
	{
	...
	},
	{
		...
		ko: "수염을 기른 한 남자가 우리에게 다가와, 지역 공동묘지에 구울 한 무리가 살고 있다고 말했다. 그는 그들의 목에 걸린 현상금에 관심이 없는지 물었다.<br/><br/>If you accept, skirmish with Flesh Eating Ghouls with their skirmish counter at maximum. He gives each character 20 Coins as an additional award."
	},
	{
	...
	},
	{
		...
		ko: "집을 잃고 방랑하게 된 인근 마을 주민들이 밀려오는 어둠에 맞서 살아남기 위해 우리에게 도움을 간청했다.<br/><br/>Any character who sacrifices 10 Coins or 1 consumable Item receives 8 Lore."
	},
	{
	...
	},
	{
		...
		ko: "우리는 자신을 제법 이름 있는 약재상이라고 소개하는 남자와 마주쳤다.<br/><br/>The group may take advantage of Apothecary services as if in a town."
	},
	{
	...
	},
	{
		...
		ko: "우리는 여행 중 길가에 있는 작은 묘지에 도착했다. 그곳에서 바쁘게 무덤을 파고 있던 노인이 우리를 알아챘다. 그는 물집이 잡힌 자신의 손을 보여주며 붕대를 나누어 달라고 요구했다.<br/><br/>One character may discard a Bandage to receive 8 Lore. Otherwise 그는 화를 내며 우리에게 덤벼든다. the group must skirmish with the Undertaker."
	},
	{
	...
	},
	{
		...
		ko: "우리는 어둠 속에서 무언가와 마주쳤다. 동료 하나가 어느새 두 명이 되어 있었다.<br/><br/>A doppelganger takes the shape of a random character. The group must skirmish with it, the skirmish counter set to 1d4. Its attacks cause 1d4 Damage. Roll a d6 for each hit against it. On a d6:4+, instead of reducing the skirmish counter, the real character is hit."
	},
	{},
	{},
	{
	...
	},
	{
		...
		sub: [
			...
			},
			{
				...
				ko: "우리는 싸우기로 마음을 먹었고 늦지 않게 전투 준비를 마칠 수 있었다. 곧 한 무리의 굶주린 늑대 무리가 우리를 덮쳤다.<br/><br/>Skirmish with a Rabid Wolf, their skirmish counter at maximum."
			},
		]
	},
	{
	...
	},
	{
		...
		sub: [
			...
			{
				name: "이 마녀들을 전부 소탕한다.",
				ko: "마녀들은 사람들을 해치려 하고 있었고, 우리는 당장 행동해야 할 때임을 깨달았다. 우리는 사악한 마녀 집회를 부수기 위해 돌진했다.<br/><br/>Skirmish with a Bruja with +2 to the skirmish counter. 그 후, 당신은 대학살의 현장에서 find your choice of an Item or a Ritual."
			}
		]
	},
	{
		...
		sub: [
			{
				...
				ko: "우리는 마녀들의 의식을 방해하기 위해 돌진했다.<br/><br/>Skirmish with a Stregha with the skirmish counter at maximum. 그 후, 남자는 자신이 살아있다는 것을 깨닫고 우리가 그를 구해준 것에 감사를 표했다. Gain a Militia Companion."
			},
			{
				name: "무슨 일이 일어나는지 보기 위해 기다린다.",
				ko: "우리는 초조하게 마녀들이 의식을 끝내는 것을 지켜보았다. 오망성 위에 누워있던 남자가 비틀거리며 몸을 일으켰다. 그는 곧 뒤틀린 근육을 가진 끔찍한 괴물로 변했다. 그는 자신의 창조자들을 공격하여 그들 모두를 갈기갈기 찢어버렸다. 그리고는 우리에게로 시선을 돌렸다.<br/><br/>Encounter the Abomination. Use the Open Road adventure map, placing him in the center with all characters together at a far end. 그 후, 당신은 마녀들의 소지품에서 find a Ritual."
			}
		]
	},
	{
		...
		sub: [
			{
				...
				ko: "그는 지친 목소리로 말했다. \"난 이 영원한 삶에 지쳤다. 나의 힘만으로는 부족하다. 너희가 나를 도와 나를 파괴해 내가 모든 것을 잊고 쉴 수 있게 해다오!\"<br/><br/>Skirmish with a Vampire with its counter at 1. Gain an Item after the combat is complete, in addition to normal awards."
			},
			{
	...
	},
	{
		...
		ko: "우리는 작은 농장을 발견했고, 휴식을 취하기 위해 멈추었다. 작은 소녀가 문 앞에 나타나 겁에 질린 채 자신의 부모가 병에 걸렸다고 말했다. 소녀는 우리의 도움을 간청했다.",
		sub: [
			{
			...
			},
			{
				...
				ko: "우리의 능력으로는 그 가엾은 소녀와 그녀의 부모를 도울 수가 없었다. 우리는 그녀에게 미안하다고 말한 뒤, 출발 준비를 했다. 그녀의 두 눈에 떠오른 절망 가득한 눈빛에 우리의 가슴은 찢어질 것만 같았다.<br/><br/>All characters lose 15 Lore, and any Boons and positive statuses they possess."
			}
		]
	},
	{
		...
		sub: [
			...
			},
			{
				...
				ko: "우리는 그의 안전을 빌어준 뒤 사냥꾼을 지나쳤다. 하지만 그는 멈춰 서서 우리에게 붕대가 필요하지 않으냐고 물었다.<br/><br/>You may purchase one Bandage for each character (5 coins each)."
			}
		]
	},
	{
	...
	},
	{
		...
		sub: [
			...
			},
			{
				...
				ko: "사냥꾼은 도움은 필요 없다고 말하며, 식사를 같이 하지 않겠느냐고 물었다.<br/><br/>The group is allowed to rest without using their standard chapter's rest, although they must roll for a skirmish as normal."
			}
		]
	},
	{
		...
		sub: [
			{
				...
				ko: "그는 당신이 건네준 물건을 허겁지겁 집어삼켰다. 그의 목소리가 더는 떨리지 않았다. \"감사합니다. 한 달 전에 괴물 늑대가 저를 공격했습니다. 저는 저주를 받았고 보름달이 떠오를 때면 야수로 변할 수밖에 없었습니다. 저는 평범한 사람이고 그 누구도 해치고 싶지 않습니다. 덕분에 오늘 밤은 무사히 넘길 수 있을 것 같습니다.\"<br/><br/>Discard a Wolvesbane or a Quicksilver. The character sacrificing the item receives a Boon and 15 Lore."
			},
			{
		...
		sub: [
			{
				...
				ko: "주변에 삽이 널려 있는 것으로 보아 무덤은 최근에 파헤쳐진 것으로 보였다. 이것은 도굴꾼들의 짓이 틀림없었다. 하지만 그들에게 무슨 일이 벌어진 것일까? 우리가 그곳을 떠나려던 순간 누군가 걸걸한 목소리로 외쳤다. \"또다시 도둑놈들이 이곳을 더럽히러 왔나? 지난번처럼 해치울 수밖에 없겠군.\"<br/><br/>Skirmish with the Undertaker and his Vicious Hound. A random character finds an Item after the fight."
			},
			{
	...
	},
	{
		...
		sub: [
			...
			},
			{
				...
				ko: "우리는 웅덩이의 물로 갈증을 없앴다. 하지만 우리는 곧 이것이 그저 눈에 보이는 대로 아름답기만 한 자연적인 물웅덩이가 아님을 알게 되었다.<br/><br/>All characters gain 1d4 Vita, 하지만 물에 비친 당신의 모습이 멋대로 움직이더니 웅덩이 밖으로 기어 올라온다. Each character must skirmish with themselves using their equipped weapon. Set each skirmish counter to 1."
			}
		]
	},
	{
	...
	},
	{
		...
		item: [
			"당신은 산과 언덕, 숲과 고대의 길을 지나 기나긴 여행을 했다. 당신이 목적지에 가까워졌을 때 하늘에 어둠이 내리며, 답답한 공기가 주변을 가득 채운다. 당신이 고용한 역마차는 종탑과 거대한 아치형 나무문이 있는 오래된 석조 건물에 접근한다. 그 안에 있는 책과 문서에는 수많은 공포의 존재들과 그에 대항하는 방법이 적혀있다. 마차가 멈추고 당신은 교차로의 교회(the Church of the Crossroads)로 들어가기 위해 내린다. 그 교회는 오래된, 기념비적인 건축물이자 이 지역의 산악 지대로 들어가기 위한 관문이다. 나무로 된 정문을 열고 안으로 향하자 안쪽에서 소란스러운 소리가 들려온다.<br/><br/> 교회 안으로 들어서자 강도들과, 그들에게 붙들려 웅크려 떨고 있는 나이 든 관리인이 보인다. 강도들은 넝마를 걸친 채 초췌한 모습을 하고 있다. 궁지에 몰려 범죄에 손을 댄 그들은 음식과 돈이 될만한 것들을 요구하고 있다.<br/><br/><br/> ...<br/><br/><br/> <b>STORY SKILL CHECK<br/>SPEECH 8</b> - Any One Character<br/><br/> <b>강도들이 평화롭게 이곳을 떠나도록 설득하라!</b><br/><br/> ",
			{
				name: "<b>성공:</b> 당신은 상황을 진정시키고 그들에게 떠나라고 요구한다. 그들은 이곳이 그들이 원하는 것을 얻기에 적절한 곳이 아님을 깨닫고는 떠나기로 한다. Gain a Boon."
			},
			"<br/>",
			{
				name: "<b>실패:</b> Skirmish with the Highwaymen. 접전 후, 강도들은 달아난다."
			},
			"<br/><br/> ...<br/><br/><br/> 관리인은 당신이 강도들을 쫓아내고 교회의 물건을 도둑맞지 않도록 해준 것에 감사를 표한다. 그는 이 지역에 불미스러운 일들이 생기기 시작했으며, 북쪽에는 훨씬 더 심한 재앙이 닥치고 있다고 말한다.<br/><br/> 그가 이야기한다, \"며칠 전 이것이 교회에 도착했다오. 사제께선 그 즉시 조사를 위해 떠나셨지!\" 그는 경고도 없이 테이블 위에 있던 덮개를 들어 올려 피투성이가 된 털투성이의 사체를 보여준다.<br/><br/><br/> <b>STORY SKILL CHECK<br/>NERVE 4</b> - All Characters<br/><br/> <b>토할 것 같은 기분을 억눌러라!</b><br/><br/> ",
			{
				name: "<b>성공:</b> 당신은 밀려오는 욕지기를 참아낸다. 당신은 속을 진정시키고 recover 1 Vita."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 괴물의 사체의 끔찍한 모습과 냄새에 당신의 속이 울렁거린다. 당신은 그것은 평범한 동물의 사체가 아니라는 것을 깨닫는다. 당신은 밀려오는 욕지기를 참지 못해 최근에 먹은 것들을 토해내고 lose 2 Vita."
			},
			"<br/><br/> 끔찍한 광경의 충격에서 벗어난 뒤, 당신은 그것을 자세히 살펴본다... 그것은 부자연스러워 보인다. 관리인이 설명한다. \"최근 북쪽에서 늑대들이 사람들을 습격했다오. 오스테링크(Ostelink)의 사냥꾼들이 놈들을 추적했지만, 아무리 창에 찔리고 화살을 맞아도 놈들은 움직임을 멈추지 않았지. 사악한 저주가 관련되어 있다고 믿은 사냥꾼들은 이 사체를 먼저 연금술사에게 가져갔다오. 이 사체는 주기적으로 모습을 바꾸었지... 그 뱃속에서 이 돌을 꺼내기 전까지는 말이요.\" 그는 테이블 근처에 있는 유리 상자로 덮인 받침대와, 그 위에 놓인 작은 돌을 가리킨다. \"사제님과 연금술사 모두 이 돌의 정체를 알지 못했지. 하지만 두 사람은 이 돌이 북쪽에서 벌어지고 있는 사건과 관련이 있다고 믿었다오.\"<br/><br/> \"오스테링크로 가서 실종된 사제님을 찾아주시오. 그곳 주민들에게 어디에 가면 그 괴물들을 찾을 수 있는지 알아낼 수 있을 것이야. 늑대 괴물의 소굴을 찾아내는 것이 무엇보다 중요하오. 여기 여행에 도움이 될 은화 몇 닢을 드리리다. 그리고 지하실에서 쓸만한 물건을 찾아보시오. 사제님을 찾고 부디 좋은 소식을 들려주시게나.\"<br/><br/><br/> ...<br/><br/><br/> 당신은 밖에서 당신을 기다리던 역마차에 올라타고 서둘러 오스테링크로 향한다.<br/><br/><br/> ...<br/><br/><br/>"
		]
	},
	{
		name: "OSTELINK’S AILMENT (5~6): 오스테링크의 걱정거리",
		item: [
			"...<br/><br/><br/> 오스테링크의 거리는 텅 비어있다. 가끔 서둘러 집으로 돌아가는 마을 주민 또는 술에 취해 골목에서 잠이 든 방랑자가 눈에 띌 뿐이다. 지나가던 주민들은 발을 멈추고 조심스러운 시선으로 당신을 바라본다. 당신은 몇 번이고 친절하게 손을 흔들며 그들과 인사를 나누려 하지만 그들은 재빨리 시선을 피하며 당신을 외면한다. 무언가가 잘못되었다는 것을 쉽게 알아차릴 수 있었다.<br/><br/> 당신은 골목길에서 부랑아 하나가 당신을 바라보고 있는 것을 눈치챈다. 다른 사람들과는 달리, 그녀는 두려움보다 호기심이 컸던 모양이다. 당신이 그녀에게 손을 흔들자 그녀는 주저하며 당신에게 다가온다. 당신이 마을에 관해, 그리고 사람들이 무엇을 이토록 두려워하고 있는 것인지 묻자, 그녀는 겁먹은 표정으로 말한다. \"최근 이상한 일들 벌어져서 다들 겁에 질려 있어요. 변두리에서는 더 심한 모양인지 농장에 살던 사람들도 마을로 왔고요. 덕분에 여관에 남은 방이 없을 지경이에요.\"<br/><br/> 당신은 소녀에게 늑대, 그리고 실종된 사제에 대해 묻는다. 그녀는 잠시 모르는 척을 하지만, 당신이 음식을 나누어 주자 최근에 많은 사람이 늑대를 목격했다는 이야기를 들려준다. 그녀는 또한 늑대들이 달빛 아래에서 그 모습을 바꾸는 것을 본 사람들이 있다며 조심하라는 말을 한다. 그리고 그녀는 당신이 준 음식을 우물거리며, 자신은 이곳에 왔다는 사제에 대해 아는 것이 없지만, 여관에 가면 더 많은 이야기를 들을 수 있을 거라고 말한다.<br/><br/><br/> ...<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>소녀에게 돈을 좀 주겠는가?</b><br/><br/> ",
			{
				name: "<b>• 선택 1:</b> 은화를 가지고 있는 캐릭터 하나는 그녀에게 은화 한 닢을 줄 수 있다. 그 캐릭터는...",
				item: [
					"<b>Story Moment 25</b><br/><br/> 당신이 정보의 대가로 은화 하나를 던져주자, 거지 소녀는 그것을 공중에서 잡아채 눈 깜짝할 사이에 주머니에 집어넣는다. 그녀는 자리를 떠나기 위해 돌아서지만, 잠시 멈춰 서서 말한다. \"한 가지 더 있어요. 늑대들은 높게 자란 풀숲에 숨어 먹잇감을 노리고는 해요. 부디 조심하세요.\"<br/><br/> <b>Gain the BLUE Story Marker.<br/>Story Markers are awards that can either cause a positive or negative event later in a story, but players will not know which is the case until it is revealed. Don't read ahead in the story! A Story Marker CANNOT be given to another character. Once the Story is completed, all Story Markers are discarded.</b>"
				]
			},
			"<br/>",
			{
				...
				item: [
					"<b>Story Moment 70</b><br/><br/> 당신은 잠시 망설이며 거지 소녀에게 돈을 좀 쥐여 줄지 말지 고민한다. 하지만 이 정도 정보라면 빵을 나누어 준 것으로 충분하다는 결론을 내린다. 당신은 일행에게로 돌아가 그들과 함께 여관으로 가보기로 한다.<br/><br/> <b>The Leader 는 부랑아가 당신의 주머니를 노리고 있는 것을 눈치채기 위해 must pass AWARENESS 9.</b><br/><br/> ",
					{
						name: "<b>성공:</b> 눈치채인 것을 깨달은 소녀는 밤의 어둠 속으로 달아난다.<br/><br/> "
					},
					{
						name: "<b>실패:</b> Lose 1d4 Coins. 당신은 한참 후에야 그녀에게 소매치기를 당했다는 것을 눈치챈다."
					}
				]
			},
			"<br/><br/>부랑아의 말대로, 여관은 사람들이 가득 차있어 몹시 소란스러웠다. 그들 대부분은 농부로 보이지만, 간혹 상인으로 보이는 사람도 눈에 띈다.<br/><br/> 당신이 들어서자 그들은 갑자기 입을 다문다. 당신은 그들이 당신을 환영하지 않는다는 것을 쉽게 알 수 있었다. 여관 주인이 말한다.<br/><br/> \"여기엔 무슨 일이오?\"<br/><br/> 당신은 사람들에게 실종된 사제와 마을을 곤경에 빠뜨리고 있는 이상한 늑대에 관해 아는 것이 없는지 묻는다. 여관 주인이 거칠게 대답한다. \"우리는 사제님에 대한 것은 아무것도 모르오, 그리고 당신 같은 사람들의 도움이 없이도 늑대 몇 마리 정도는 처리 할 수 있소만.\"<br/><br/> 그는 날이 선 말투로 이야기하지만, 당신은 손님 몇몇이 불안해하는 것을 눈치챈다.<br/><br/> 그는 다른 이들이 불안해하는 것을 무시하며 말을 잇는다. \"남은 방은 없소이다. 술은 주문해도 되지만, 다 마신 후에는 나가 주시오.\"<br/><br/><br/> <b>STORY SKILL CHECK<br/>TRICKERY 7</b> - A Random Character<br/><br/> <b>당신은 여관을 떠나지 않고 사람들로부터 정보를 모아보려 한다. 하지만 당신이 이곳에 있는 것을 싫어하는 사람이 있는 것이 분명하다. 빈 병 하나가 당신을 향해 날아온다.</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 날아오는 빈 병을 교묘하게 피한다. 그 병은 당신의 뒤에 있는 벽에 부딪혀 산산이 조각난다. 행운이 당신을 따르는 것 같다. Gain +1 on your next search roll.<br/><br/> "
			},
			{
				name: "<b>실패:</b> 빈 병이 머리를 강타해 당신은 고통에 휩싸인다. Lose 2 Vita."
			},
			"<br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>그들의 도발에 당신은 화가 치밀어오른다! 그들은 당신을 점점 얕보고 있는 듯하다. 당장에라도 주먹이 날아올 분위기이다!</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 누군가가 다치는 일이 벌어지지 않도록 사람들을 진정시키기로 한다면,",
				item: [
					"<b>Story Moment 37</b><br/><br/> 우리는 흥분한 군중을 진정시켜야 한다!<br/><br/> <b>Choose a character to make a SPEECH 8 check.</b><br/><br/> 일행 중 누군가가 빈 병에 얻어맞았었다면, 그들은 자신감을 얻었기에 you receive a -1 penalty.<br/><br/> ",
					{
						name: "<b>성공:</b> 당신은 그들을 진정시키는 데 성공하고 그 결과 become RESPECTED.<br/><br/>"
					},
					{
						name: "<b>실패:</b> 당신은 흥분한 군중에게 더욱 얕보이고 만다... 난투가 시작된다! Skirmish with an Angry Mob."
					}
				]
			},
			"<br/>",
			{
				...
				item: [
					"<b>Story Moment 58</b><br/><br/> 이런 일로 시간을 낭비하긴 싫지만, 싸움을 피할 수 없어 보인다. 당신은 그들이 준비되기 전에 먼저 공격하기로 한다. 난투가 시작된다!<br/><br/> <b>Skirmish with a Angry Mob and apply a -1 to the skirmish counter (minimum 1 on the counter).</b>"
				]
			},
			"<br/><br/>그들의 흥분은 쉽게 끓어오른 만큼이나 쉽게 식어버렸다. 그들은 겁에 질려있었다. 이것으로 그들이 이토록 쉽게 흥분한 이유는 설명되었지만, 그보다 당신을 놀라게 한 것은, 일단 흥분이 식고 나자 그들이 절망감에 빠져들었다는 것이다. 그들은 마치 그들이 아무리 이 재앙에 맞서봐야 아무런 소용도 없다고 믿고 있는 듯하다.<br/><br/> 소란이 진정된 후, 농부 하나가 망설이며 다가와 말한다. \"말씀하신 사제님께서 제 땅을 지나다 누리안의 동굴(Nurian's Hollow)로 가는 길을 물으셨었습니다. 저는 그분께 지름길을 알려 드렸습지요. 다음날, 미친 늑대들이 언덕에서 내려와 제 가축들을 잡아먹고 제 가족을 공격했습니다. 전 도움을 청하러 오스테링크로 달려왔습니다만, 모두들 겁을 집어먹고 마을을 벗어나려 하지 않습니다. 그 늑대 놈들을 잡아주신다면, 제가 지름길을 알려 드립지요.\"<br/><br/><br/> ...<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>시간을 내 농부를 돕겠는가?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 당신에게는 그런 일을 할 여유가 없다. 그의 요청을 거절한다면,",
				item: [
					"<b>Story Moment 78</b><br/><br/> 당신은 농부를 돕지 못해 미안함을 느낀다. 그는 좋은 사람인 듯하며 간절히 도움을 바라고 있다. 하지만 당신이 가장 우선해야 하는 일은 실종된 사제를 찾는 것이다. 그가 위험에 처해 있을지도 모르니 서둘러야만 한다. 당신은 사제가 찾아갔다고 하는 누리안의 동굴로 떠날 준비를 한다.<br/><br/> <b>Continue the story by skipping to \"Journey to the Hallows (Choice One)\" on page 6.</b>"
				]
			},
			"<br/>",
			{
				...
				item: [
					"<b>Story Moment 46</b><br/><br/> 당신은 이 남자가 당신에게 도움을 요청하기 위해 얼마나 많은 용기를 내야 했는지 알 수 있었다. 그는 눈에 띄게 겁을 먹고 있었지만, 그 두려움을 극복한 것이다. 늑대 몇 마리를 상대하는 데는 많은 시간이 걸리진 않을 것이다. 게다가 그 농부가 알려주기로 한 지름길을 이용한다면 그 정도 시간은 만회할 수 있을 것이다.<br/><br/> <b>Skip to \"The Farm (Choice Two)\" on page 6.</b>"
				]
			}
		]
	},
	{
		...
		item: [
			"당신은 오스테링크를 떠나 누리안의 동굴로 향한다. 당신은 그곳에 대해 아는 것이 거의 없지만, 그 안에 도사리고 있는 어둠의 존재에 대한 소문은 들어 본 적이 있다.<br/><br/><br/> ...<br/><br/><br/> 짧은 여행을 마친 뒤, 당신은 누리안의 동굴에 도착한다. 불행히도 동굴 입구가 무너져있다! 잔해를 치우고 안으로 들어가는 것은 무리일 듯하다. 다른 방법을 찾아 주변을 조사하던 당신은 산 언덕에 있는 묘지 하나를 발견한다. 묘지 입구에서 노인 하나가 무덤을 파고 있다. 당신은 그에게 다가가 동굴로 들어가는 방법이 있는지 묻는다.<br/><br/><br/> <b>STORY SKILL CHECK<br/>SPEECH 9</b> - Any One Character<br/><br/> <b>노인에게 누리안의 동굴로 들어갈 방법이 없는지 질문하라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 노인은 안쪽에 있는 오래된 영묘(mausoleum)에 대해 이야기해준다. 몇 년 전의 지진으로 그 내부에 산 안쪽으로 이어지는 굴이 뚫렸다고 한다. 이것이 그가 아는 유일한 방법이라고 한다. Gain 8 Lore."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 노인은 삽에 기대어 당신의 눈을 똑바로 바라본다. \"보아하니 넌 이 늙은이가 몹시 하찮아 보이는 모양이군. 그래. 위대한 모험을 하고 계시니 말을 그따위로 해도 된단 말이지? 내가 늙다리인 건 사실이지만, 너 같은 놈을 혼내줄 만한 힘은 남아 있어. ...바로 이 삽으로 말이야!\" Skirmish with the Undertaker. 요란한 환영 인사 후, 그는 안쪽에 있는 오래된 영묘(mausoleum)에 대해 이야기해준다. 몇 년 전의 지진으로 그 내부에 산 안쪽으로 이어지는 굴이 뚫렸다고 한다."
			},
			"<br/><br/>..."
		]
	},
	{
		...
		item: [
			"농부는 당신을 마을 밖에 데리고 나온 뒤, 자신의 농장이 있는 방향을 가리킨다. \"저 길로 가면 제 농장이 나옵니다. 제발 부탁드립니다. 늑대들을 물리쳐 주십시오.\"<br/><br/> 당신이 농장에 도착했을 때는 이미 해가 진 후였다. 두꺼운 구름이 달을 가리고 있었지만, 별이 밝아 시야는 충분했다. 주변은 고요하지만, 곧 낮게 으르렁대는 소리가 들려온다. 커다란 풀 속에 숨어있던 늑대들이 당신의 냄새를 맡고 모습을 드러낸다. 광란에 빠진 놈들의 눈은 마치 빛나는 것처럼 보인다.<br/><br/><br/> ...<br/><br/><br/><b>MAP SKILL CHECK<br/>ECOLOGY 5</b> - Any One Character<br/><br/> <b>기둥에서 떨어진 허수아비가 바닥에 누워있다. 까마귀들이 당신을 조롱하듯 울어대고 있다.</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 허수아비를 제자리로 돌려놓는다. Earn a Boon."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신은 허수아비를 다시 세우다 넘어져 버린다. Lose 1d4 Vita."
			},
			"<br/><br/> ...<br/><br/><br/> <b>AFTER THE FIGHT</b><br/><br/> 늑대들을 처리한 뒤, 농부가 당신에게 이야기한다. \"이쪽으로 가면 오래된 묘지가 나옵니다. 그곳에 있는 영묘(mausoleum)에 누리안의 동굴으로 들어가는 잊혀진 입구가 있습지요... 사제님께선 그곳으로 가셨습니다.\" 그는 당신과 함께하며 길을 안내해주겠다고 한다. The Leader gains the Farmer Companion.<br/><br/><br/> ..."
		]
	},
	{
		name: "INTO THE HOLLOW (7~8): 동굴을 향해",
		item: [
			"당신은 오래된 묘지에 들어선다. 곧 누리안의 동굴과 이어져 있다는 영묘가 모습을 드러낸다. 왼쪽에는 파헤쳐진 무덤이 있다. 당신은 동굴로 이어지는 입구를 찾기 바라며 서둘러 영묘 지하로 내려가는 문으로 향해 나아간다.<br/><br/><br/> ...<br/><br/><br/> <b>MAP SKILL CHECK 2<br/>TRICKERY 7</b> - Any Character During Their Turn<br/><br/> <b>영묘로 들어가는 문을 열 수 있는가?</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 잠긴 문을 연다. Remove it from the map."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신은 자물쇠를 따다 손을 다친다. Lose 2 Vita. You may try again on your next turn."
			},
			"<br/><br/> ...<br/><br/><br/><b>MAP SKILL CHECK 1<br/>AWARENESS 6</b> - Any One Character<br/><br/> <b>특이한 점을 눈치챈 것이 있는가?</b><br/><br/>",
			{
				name: "<b>성공</b>",
				item: [
					"<b>Story Moment 34</b><br/><br/> 무덤 안에는 복부가 파헤쳐져 내장을 씹어 먹힌 반쯤 말라붙은 시체가 있다. 그 안에서 무언가가 반짝인다. 당신이 욕지기를 참으며 시체 안에 손을 넣자 무언가 둥글고 단단한 것이 만져진다. 조심스럽게 꺼내보자, 그것은 진주 반지였다. 아름답고 섬세하게 세공된 그 반지에는 마른 피가 달라붙어 있다. 그것을 손가락에 끼우고자 하는 충동이 밀려온다. 당신은 그 유혹에 저항하지 못했다!<br/><br/> <b>Gain the RED Story Marker.</b>"
				]
			},
			"<br/>",
			{
	...
	},
	{
		...
		item: [
			"당신이 영묘의 문을 통과하자 방 반대편의 벽에 누리안의 동굴로 이어지는 구멍이 나 있는 것이 보인다.<br/><br/> 구멍 안쪽은 어둡고, 썩은 고기 냄새가 풍겨온다. 당신의 모든 감각이 이곳에서 도망치라고 외치고 있지만, 당신은 용기를 짜내 벽 안의 구멍으로 발을 들인다.<br/><br/><br/> <b>STORY SKILL CHECK<br/>NERVE 4</b> - All Characters<br/><br/> <b>두려움을 이겨내고 어둠 속으로 발을 내디뎌라!</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 온몸에 자신감이 솟구치는 것을 느낀다! The Darkness penalty you receive in the next map is reduced by 2."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신은 앞으로 나아가야만 한다. 당신은 분명 다른 방법이 없다는 것을 알고 있다. 하지만 이 앞에 무엇이 있을지를 깨닫는 순간, 당신의 온몸이 두려움으로 떨려온다. Become <b>SPOOKED.</b>"
			},
			"<br/><br/> 동굴은 어둡고 축축하며 냉기가 감돈다. 당신은 발을 헛디뎌 휘청이며 어둠 속을 나아간다. 몇 분 정도 악몽 같은 시간이 흐른 뒤, 당신은 앞쪽에서 무언가가 빛나는 것을 눈치챈다. 희미하게 빛을 발하고 있는 버섯이 이곳이 저승이 아니라는 유일한 증거가 되어준다.<br/><br/> 통로가 점점 좁아진다. 폐소공포증이 당신을 덮쳐, 당신은 마음을 진정시키기 위해 심호흡을 한다. 갑자기, 전방에서 움직임이 느껴진다. 거의 눈치채지 못할 정도로 조용히, 어둠 속에서 무언가가 다가오고 있다!<br/><br/><br/> ...<br/><br/><br/> <b>OPTIONAL GOALS</b><br/><br/> <b>• Investigate all search locations.</b><br/><br/> <b>• 당신은 돌무더기를 옮겨 통로를 열 수 있다. 하지만 사제가 이 통로를 지나간 것 같진 않아 보이며, 그 너머에는 무언가 위험이 도사리고 있을 수 있다. One character may spend their ACT to remove the Rubble token.</b><br/><br/>",
			{
				name: "<b>돌무더기를 치우고 길을 연다면,</b>",
				item: [
					"<b>Story Moment 53</b><br/><br/> 돌무더기를 치우자, 그 너머에는 한동안 인간의 손길이 닿지 않았던 것으로 보이는 동굴이 모습을 드러낸다. 천장의 작은 틈새들을 통해 내려온 달빛이 가느다란 빛줄기를 만들어내 동굴 안을 희미하게 비춘다. 그 빛을 통해 당신은 작고 검은 무언가가 천장을 가득 메우고 있는 것을 눈치챈다... 박쥐들이다! Remove the Darkness token from the map.<br/><br/> 수정처럼 맑은 물웅덩이 두 개가 보인다. 그것은 당신에게 치유의 힘을 가진 신비한 샘물에 관한 이야기를 떠올리게 한다. 그 물을 마시고자 하는 캐릭터는 must pass ECOLOGY 5 while adjacent to them.<br/><br/>",
					{
						name: "<b>성공:</b> Recover 2d6 Vita."
					},
					"<br/>",
					{
						name: "<b>실패:</b> Recover 1d4 Vita."
					},
					"<br/><b>Each space a character moves while in the revealed cavern requires them to roll TRICKERY 2. On a failure, there is no need to make the check again, but the group encounters either 2 Bat Swarms (or a single Bat Swarm for 2-3 characters). Place the swarms atop the spawn locations. If the group is still fighting the Night Stalkers, the check is automatically failed. See the Rulebook “Swarms” on page 28 for details on their behavior and movement. Once the group have defeated all foes, they may interacted with any map features.</b>"
				]
			},
			"<br/><br/>..."
		]
	},
	{
		...
		item: [
			"당신은 동굴 안쪽으로 들어간다. 높은 벽의 틈새 사이로 들어온 달빛이 방안을 비추고 있다. 누군가가 그 빛줄기를 아래에 서 있는 모습이 보인다. 당신은 달빛에 닿은 그의 얼굴이 변하기 시작하는 것을 눈치챈다. 곧 그의 피부와 뼈가 요동치며 그의 몸은 인간의 것에서 사나운 늑대의 것으로 변한다. 하지만 그가 당신을 향해 돌아서 달빛 밖으로 발을 내딛자, 그의 얼굴은 다시 완전한 사람의 것으로 돌아온다.<br/><br/> 동굴의 뒤편에 한 남자가 거꾸로 매달려 있는 것이 보인다. 두건을 쓴 사람들이 그를 둘러싸고 있다... 바로 당신이 찾던 사제다! 그때 당신 앞에 있던 남자가 으르렁대는 소리와 함께 당신을 덮친다!<br/><br/> If the RED Story Marker is in play, Otherian the Changer 는 반지를 끼고 있는 캐릭터에게 다가가 외친다. \"그것은 나의 것이다! 그 돌을 내놓아라!\" 당신은 진주라고 생각했던 반지의 돌이 사실은 진주와는 다른, 광택 나는 돌이라는 것을 깨닫는다. 그 돌은 아주 희미하게 빛나고 있다... 마치 달빛처럼. 당신은 무슨 짓을 해도 반지를 손가락에서 빼낼 수가 없다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>The character with the RED Story Marker: 이 망할 반지를 빼낼 수가 없어. 이 짐승이 날 죽이고 말 거야. 난 어쩌면 좋지?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 죽을 때 죽더라도 싸울 테다. 그것이 내가 여기까지 온 이유니까!",
				item: [
					"<b>Story Moment 8</b><br/><br/> 난 할 수 있어! 친구들이 날 지켜줄 테니까. 우리는 저 괴물을 막아야만 해!<br/><br/> <b>Become BRAVE.</b>"
				]
			},
			"<br/>",
			{
				...
				item: [
					"<b>Story Moment 63</b><br/><br/> 이게 유일한 방법이야! 만약 이 괴물이 나만 노리고 덤벼든다면, 난 1분도 채 버티지 못할 거야. 그것은 끔찍하게 고통스러울 것이다! 당신은 숨을 크게 들이쉰 뒤 손가락의 마디 부분을 잘라낸다. 당신은 고통으로 비명을 지른다!<br/><br/> <b>나쁜 소식:</b> Lose 2d4 Vita and receive a -5 Might penalty for the remainder of the story.<br/><br/> <b>더 나쁜 소식:</b> 괴물은 반지가 끼워져 있는 손가락을 낚아채 그것을 통째로 삼켜 버린다. Otherian gains +5 Might and +1 Damage for the remainder of combat."
				]
			},
			"<br/><br/>...<br/><br/><br/><b>OPTIONAL GOALS</b><br/><br/> <b> • 사제가 죽기 전에 그를 구출하라(completing this map skill check). YOU HAVE ONLY 6 ROUNDS.</b><br/><br/> <b>MAP SKILL CHECK<br/>TRICKERY 6</b> - 사제를 구출하기 전까지 ANY CHARACTER<br/><br/> <b>사제에게는 남은 시간이 얼마 없다. 당신은 서둘러 그를 구해내야 한다.</b><br/><br/> ",
			{
				name: "<b>성공:</b> 당신은 재빨리 사제를 구해낸다. 그의 상태는 그다지 좋아 보이지 않는다. 당신이 그의 상처를 돌보자 그는 신음한다. 그는 안전하다. 지금 당장은 말이다. Gain 8 Lore."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신은 사제를 묶고 있는 매듭을 풀어낼 수 없을 것 같다. You may try again on your next turn."
			},
			"<br/><br/> ..."
		]
	},
	{
		...
		item: [
			"<b>IF YOU WON THE BATTLE</b><br/><br/>",
			{
				name: "• 당신이 제시간에 사제를 구출할 수 있었다면,",
				item: [
					"<b>Story Moment 44</b><br/><br/> 어더리언은 동굴 바닥에 쓰러져 미동도 하지 않는다. 곧, 그의 몸이 천천히 인간의 것으로 되돌아간다. 방의 반대편 벽에 기대어 앉아 있던 사제가 작은 신음을 낸다. 당신은 달려가 그가 몸을 일으키는 것을 돕는다.<br/><br/> 그는 당신에게 감사하며 말한다. \"제가 동굴의 비밀을 밝히려던 순간 어더리언이 저를 붙잡았습니다. 이 동굴에는 사람을 동물로 변화시키는 기이한 광물이 있습니다. 그것은 마치 마약과 같은 중독성이 있는 모양입니다. 사냥꾼들이 저에게 가져왔던 돌 역시 바로 그 광물이었습니다. 어더리언이 북쪽 땅에서 이곳까지 온 이유는 이 광물을 캐내기 위해서였습니다. 그는 그 광물이 자신을 더 강하게 만들 것이라고 떠들어대더군요. 그가 한 말이 사실인지는 모르겠지만, 그가 얼마나 강력한 존재였는지를 생각하면, 더 늦기 전에 그를 쓰러뜨린 것이 무엇보다 다행입니다. 우리는 결국 이 끔찍한 시련을 극복해냈습니다. 함께 감사의 기도를 올리도록 하지요.\"<br/><br/> <b>All characters recover 6 Vita or Ghost Points.</b><br/><br/> 오스테링크에는 이미 활기가 돌아와 있었다. 그들은 감사의 표시로 당신과 사제를 교회로 돌아가게 해줄 역마차를 고용해 준다. 사제는 당신에게 경계를 늦추지 말라고 경고한다. 그는 이 사건은 단지 앞으로 다가올 더 큰 사건의 전조일 뿐이라 생각하는 듯하다."
				]
			},
			"<br/>",
			{
				...
				item: [
					"<b>Story Moment 51</b><br/><br/> 어더리언은 동굴 바닥에 쓰러져 미동도 하지 않는다. 곧, 그의 몸이 천천히 인간의 것으로 되돌아간다. 당신은 여전히 꽁꽁 묶인 채 매달려 있는 사제를 향해 달려간다. 그가 흘린 피가 바닥에 고여 웅덩이를 만들고 있다. 그를 구하지 못했다는 죄책감이 당신을 괴롭힌다. 비록 당신은 당신이 할 수 있는 모든 것을 했음을 알고 있지만 말이다. 당신은 맹세한다. 이 땅을 어둠으로부터 해방하기 위해 흔들림 없이 나아가겠다고. 당신은 적어도 오스테링크를 괴롭히는 문제의 근원을 제거할 수 있었다. 사제를 구하지 못했기에 All characters lose 8 Lore.<br/><br/> 당신이 비통에 빠져있는 사이, 그의 시신에서 사제의 영혼이 솟아오른다. 그는 허공에 떠 당신의 앞으로 다가와 말한다. \"절망하지 마십시오. 어더리언이 저를 붙잡기 전, 저는 이곳의 비밀을 깨달았습니다. 이 동굴에는 사람을 동물로 변화시키는 기이한 광물이 있습니다. 그것은 마치 마약과 같은 중독성이 있지요. 사냥꾼들이 저에게 가져왔던 돌 역시 바로 그 광물이었습니다. 어더리언이 북쪽 땅에서 이곳까지 온 이유는 이 광물을 캐내기 위해서였습니다. 그는 그 광물이 자신을 더 강하게 만들 것이라고 말하더군요. 경계를 늦추지 마십시오. 이 사건은 앞으로 다가올 더 큰 사건의 전조일 뿐입니다. 부디 제 시신을 교회로 가져가 제 조상님들 곁에 눕혀 주십시오. 부탁드리겠습니다.\" 말을 마친 사제의 영혼은 소멸한다.<br/><br/> 오스테링크에는 이미 활기가 돌아와 있었다. 그들은 감사의 표시로 당신을 교회로 돌아가게 해줄 역마차를 고용해 준다. 관리인은 사제의 죽음에 큰 충격을 받지만, 그의 강인한 영혼의 힘 덕분에 그는 빠르게 그것을 이겨낸다. 그는 당신에게 새로운 사제가 파견될 것이라 말한다. 하지만 어둠의 세력은 분명 그의 자리가 비어있는 틈을 이용할 것이다."
				]
			},
			"<br/>• If a character has the RED Story Marker and has not been killed or had his finger removed, they receive the Ring of Moonlight artifact.<br/><br/> • Place the Group Marker on the Church of the Crossroads. If any character has earned an Ability Point by collecting Lore, they may use it to learn new Abilities.<br/><br/><br/> <b>IF YOU LOST THE BATTLE</b><br/><br/> 당신은 오스테링크 변두리에 있는 집시들의 야영지에서 깨어난다. 당신은 잠시 혼란에 빠져 정신을 차리지 못한다(see <b>Rulebook “On Death and Dying” on page 32</b> and follow the instruction of Total Group Death). 정신을 차리고 나자, 집시들은 당신이 비어있는 누리안의 동굴 안에서 의식을 잃은 채 죽어가고 있었다고 말해준다. 당신이 이곳에 온 이유인 사제도 발견되었다고 한다. 갈기갈기 찢겨버린 시체로 말이다. 당신은 실패를 자책하며 괴로워하며 맹세한다. 이 땅을 어둠으로부터 해방하기 위해 흔들림 없이 나아가겠다고. 어더리언은 이제 자취를 감추었지만, 당신은 운명이 그와 당신을 다시 마주치게 할까 봐 두려움을 느낀다.<br/><br/> 어더리언이 떠나자 오스테링크는 서서히 활기를 되찾고 있다. 당신은 역마차를 고용해 교회로 돌아간다. 사제의 죽음을 전해 들은 관리인은 큰 충격을 받지만, 그의 강인한 영혼의 힘 덕분에 그는 빠르게 그것을 이겨낸다. 그는 급히 새로운 사제가 파견될 것이라 말한다. 하지만 어둠의 세력은 분명 그의 자리가 비어있는 틈을 이용할 것이다.<br/><br/><br/> <b>THE END</b>"
		]
	},
	{},
	{},
	...
	},
	{
		...
		item: [
			...
			"<br/>",
			{
				name: "B",
				item: [
					"<b>Story Moment 39</b><br/><br/> 당신은 황무지를 헤매다 그 지역을 휩쓸고 있는 재앙 때문에 화가 난 농부 무리와 마주친다. 그들 중 일부는 이미 병을 앓고 있다. 그들은 분노에 차 목소리를 높이지만, 그들의 눈에는 당혹감이 가득하다. 그들은 이 역병 앞에 무력감을 느끼고 있는 듯하다. 그들은 행정관에게 이 사태의 해결을 요구하기 위해 웨일린 포인트로 행진 중이었다.<br/><br/> <b>One character 는 군중을 진정시키기 위해 must pass SPEECH 8.</b><br/><br/>",
					{
						name: "<b>성공:</b> 농부들은 행진을 멈추고 해산한다. 농부 하나가 뒤에 남아 당신과 함께하고자 한다. Gain the Farmer companion."
					},
					"<br/>",
					{
						name: "<b>실패:</b> Skirmish with an angry Angry Mob, with an additional modifier. If a character is hit during the skirmish, they become SICKENED 6 for every hit."
					},
				]
			},
			"<br/>",
			{
				name: "C",
				item: [
					"<b>Story Moment 49</b><br/><br/> 당신은 죽은 자의 소지품을 뒤지고 있던 한 무리의 도적들과 마주친다. 죽은 사람은 보급품을 가지고 웨일린 포인트로 돌아오던 도중 이 범죄자들을 만나 그들의 희생양이 된 듯하다. 그들은 위험해 보이지만, 아직 당신의 존재를 눈치채지 못했다.<br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/>",
					{
						name: "<b>• 선택 1:</b> 그들과 맞선다면,",
						item: [
							"<b>Story Moment 72</b><br/><br/> \"멈춰! 너희에게는 그럴 권리가 없어!\" 당신은 도적들에게 다가가 당장 떠나지 않으면 호된 꼴을 당하게 해줄 거라고 소리친다. 그들은 서로 마주 보며 빙그레 웃더니 무기를 뽑아든다.<br/><br/> <b>Skirmish with Highwaymen. 싸움 후, 당신은 죽은 마을 사람의 소지품에서 의약품을 찾아낸다.<br/> The Leader receives the RED Story Marker.</b>"
						]
					},
					"<br/>",
					{
						name: "<b>• 선택 2:</b> 싸움을 피해 그곳을 떠난다. 이야기를 계속 진행한다.",
					},
				]
			},
			"<br/>",
			{
				name: "D",
				item: [
					"<b>Story Moment 45</b><br/><br/> 당신은 비어있는 판잣집을 발견한다. 그 안에는 깨끗한 담요와 장작이 준비되어 있다. 이 기회에 잠시 쉬어가는 것도 좋을 듯하다.<br/><br/> <b>All characters recover 2 Vita, and 2 Power Points or Ghost Points.</b>"
				]
			},
		]
	},
	{
		...
		item: [
			"웨일린 포인트를 찾아가 환자들을 조사해야 할 때이다. 아마도 누군가는 역병에 대한 정보를 가지고 있을지도 모른다.<br/><br/><br/> ...<br/><br/><br/> 웨일린 포인트의 사람들은 깊은 절망에 빠져있다. 당신이 의사가 어디에 있는지를 묻자, 주민 하나가 당신을 마을 회관으로 안내한다. 마을 회관은 넘치는 환자들을 위한 진료소로 바뀌어 있다. 마을 회관으로 들어서자, 그곳에는 일렬로 늘어선 병상과 그 위에 누워있는 환자들이 보인다. 환자들은 고열에 시달리고 있으며, 그들의 피부는 종기로 뒤덮여 있다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>당신은 환자들을 살펴보겠는가, 아니면 서둘러 의사를 찾겠는가?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 먼저 환자를 살펴보겠다면,",
				item: [
					"<b>Story Moment 59</b><br/><br/> 병마에 고통받고 있는 사람들 사이를 걷고 있자, 고열로 의식이 혼미해진 여인 하나가 당신의 팔을 붙든다.<br/><br/> \"저와 제 남편은 숲에 갔었답니다. 남편이 사냥을 하는 동안 저는 나물을 캤지요.\" 그녀는 기침을 했다. \"가족이 일주일은 먹을 만한 식량을 손에 넣을 수 있었어요. 저희는 고기와 나물로 국을 끓였답니다. 하지만 그걸 먹은 밤, 몸이 안 좋아지기 시작하더니 종기가 돋아났어요. 의사 선생님께서 여러 가지 방법을 써보셨지만, 병세는 나빠지기만 했답니다. 제 남편은 아직 살아있나요? 그는 의식을 잃고 깨어나지 못했어요. 제발 저희를 도와주세요!\"<br/><br/> 기운을 다 써버린 여인은 의식을 잃고 만다.<br/><br/> <b>All characters receive 8 Lore and a random character gains the BLUE Story Marker.</b>"
				]
			},
			"<br/>",
			{
	...
	},
	{
		...
		item: [
			"다큰바우 숲에 발을 들이자 당신의 피부가 따끔거린다. 당신은 숲 속의 공기에서 섬뜩한 기운을 느낄 수 있다. 그것은 당신을 부르고, 당신을 발걸음을 재촉하며, 당신을 망각으로 이끈다. 당신은 불안함을 떨치고 숲 속 깊은 곳으로 발을 내딛는다. 숲 어디에나 부패의 징후가 역력하다. 당신은 나무들이 기이한 패턴을 그리며 자라나 있는 것을 눈치챈다. 그 모양은 마치 룬 문자로 절망의 뜻이 담긴 고대의 단어를 그리고 있는 듯하다. 길이 좁아지고 두꺼운 잎사귀들이 지붕을 이루어 햇빛을 차단한다. 당신의 앞에 놓인 어둠 속에, 무언가의 윤곽이 보인다. 당신은 간신히 그것이 돌로 만들어진 고대의 아치문임을 눈치챈다.<br/><br/><br/> ...<br/><br/><br/> <b>OPTIONAL GOALS</b><br/><br/> <b>• Investigate all search locations.</b><br/><br/> <b>• Investigate the archway by completing this map skill check.</b><br/><br/> <b>MAP SKILL CHECK<br/>ARCHEOLOGY 6</b> - Any One Character<br/><br/> <b>작은 공터에 돌로 만들어진 고대의 아치문이 서 있다. 그 표면은 고대 문자로 뒤덮여있다. 그것을 자세히 살펴보자 이전에는 본 적 없었던 패턴이 보이기 시작한다.<br/>당신은 그 뜻을 알겠는가?</b><br/><br/>",
			{
				name: "<b>성공</b>",
				item: [
					"<b>Story Moment 83</b><br/><br/> 당신은 이것이 특별한 힘을 가진 고대의 주문임을 깨닫는다. 당신은 재빨리 그것을 옮겨 적는다.<br/><br/> <b>Receive 1 Ritual.</b>"
				]
			},
			"<br/>",
			{
				name: "<b>실패</b>",
				item: [
					"<b>Story Moment 33</b><br/><br/> 당신이 아치문을 자세히 살펴보기 위해 그것에 가까이 다가갔을 때, 당신은 갑자기 혼잣말을 중얼거리기 시작한다. 당신은 당신이 그 의미도 모른 채, 문에 적힌 문자들을 소리 내 읽고 있다는 사실을 깨닫는다. 갑자기 아치문이 진홍색 빛으로 번쩍이며, 당신에게 안으로 들어오라고 속삭인다.<br/><br/> <b>아치문을 조사한 캐릭터는 주문 암송을 멈추기 위해 must pass OCCULT 7.</b><br/><br/>",
					{
						name: "<b>성공</b>",
						item: [
							"<b>Story Moment 15</b><br/><br/> 당신은 암송을 멈추려 하지만, 당신의 혀가 멋대로 움직인다. 하지만 엄청난 노력 끝에 당신은 이를 악물고 암송을 멈추는 데 성공한다. 아치문의 진홍색 빛이 사그라지며, 무언가가 분노에 차 울부짖는 소리가 들려온다. 그 안에서 강력한 힘을 가진 원혼이 튀어나와 당신을 공격한다.<br/><br/> <b>Skirmish with a Restless Spirit with its skirmish counter at maximum. If you successfully defeat the spirit, the character who was interacting with the archway gains 8 Lore, in addition to the normal skirmish awards.</b>"
						]
					},
					"<br/>",
					{
						...
						item: [
							...
							{
								name: "<b>성공:</b> 당신은 동료의 손에 의해 걸음을 멈추게 되고, 당신이 주문 암송을 멈추자 아치문의 진홍색 빛은 사그라진다."
							},
							"<br/>",
							{
								name: "<b>실패:</b> 당신은 연옥으로 빨려 들어가 removed from the game. That player must silently read this and not share it with the rest of the group",
								item: [
									"<b>Story Moment 82</b><br/><br/> 당신은 살아있지도 죽어있지도 않은 채, 산 자와 죽은 자의 세계 사이의 틈새에 있다. 저 멀리에 동료들의 모습이 보이지만, 당신은 그들에게 닿을 수가 없다.<br/><br/> <b>When you transition to the next map and encounter the evil within, you may roll a FAITH 6 check at the end of every round until successful. Upon success, you use the power of your faith to break free from Limbo and appear with the group as a ghost to fight alongside them. Gain the GREEN Story Marker.</b>"
								]
							},
						]
					},
			...
			"<br/><br/><b>ATTENTION!</b><br/><br/> 주변의 나무들이 당신의 앞길을 막으려는 듯 뿌리와 가지를 뻗어온다. 놈들은 마치 사악한 의지를 품고 있는 것처럼 보인다. At the end of the adventuring round, the Leader must roll a d10. On a 1 or 2, the group must Skirmish with a Dark Oak."
		]
	},
	{
		name: "THE VILE OAK (13): 사악한 참나무",
		item: [
			"당신은 몇 시간을 어둠 속에서 헤매다, 마침내 숲의 덜 울창한 지역에 들어선다. 숲은 고요하다. 마치 이곳에 살아있는 것이라고는 당신뿐인 것만 같다. 당신은 죽은 나무들로 둘러싸인 공터에 발을 들인다. 부패의 악취가 진동한다. 그 저주받은 장소의 한가운데에는 거대한 참나무가 서 있는데, 그 잎사귀가 하늘을 덮어 공터 전체에 그림자를 드리울 정도이다. 그 괴물 같은 나무의 가지가 흔들리기 시작하고, 그 몸통 중앙에 커다란 틈이 벌어지며 삐죽삐죽한 나무껍질들이 마치 입과 같은 모양을 만든다. 당신은 이것이 숲을 괴롭히는 사악한 저주의 근원임을 깨닫는다.<br/><br/><br/> ...<br/><br/><br/> <b>AFTER THE FIGHT</b><br/><br/><br/><b>ATTENTION!</b><br/><br/>",
			{
				name: "If a character has the GREEN Story Marker,",
				item: [
					"<b>Story Moment 74</b><br/><br/> 사악한 괴물이 쓰러지자, 당신은 당신이 무엇을 위해 살고 있는지 다시금 깨닫게 된다. 당신은 처음에는 천천히, 하지만 곧 급격히 당신의 몸을 향해 끌려가고, 잠시 후 자신의 몸 안에서 깨어난다. 당신은 이해할 수 없는 힘에 의해 현실의 세계로 돌아오게 된다.<br/><br/> <b>You return with full Vita; however you have zero Power Points until you can recover them.</b>"
				]
			},
			"<br/><br/>당신이 끔찍한 흉물을 향해 마지막 일격을 날리자 그 사악한 나무는 결국 쓰러지고 만다. 당신은 승리를 만끽하지만, 곧 놈의 거대한 입을 통해 맥동하는 보라색 빛이 떠오른다. 놈의 입은 마치 땅속으로 들어가는 터널처럼 보인다. 당신은 사건이 아직 끝나지 않았다는 것을 알고 있다. 당신은 저 안으로 들어가 그 안에 숨겨진 비밀을 밝혀야만 한다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>당신은 거대한 참나무의 높다란 가지 위에서 무언가가 반짝이는 것을 눈치챈다. 가지 위로 올라가 그것이 무엇인지 살펴보겠는가?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 그럴만한 가치가 있을 것이다. 나뭇가지 위로 올라가 본다!",
				item: [
					"<b>Story Moment 17</b><br/><br/> 가지 위에 무엇이 있는지 살펴보기 위해 거대한 참나무를 타고 올라간다.<br/><br/> <b>Any one character must pass TRICKERY 7 or ECOLOGY 8.</b><br/><br/>",
					{
						name: "<b>성공</b>",
						item: [
							"<b>Story Moment 13</b><br/><br/> 당신은 가지 위로 올라 반짝이는 물체를 찾아낸다. 그것은 단순하면서 우아한 디자인의 고대 반지이다.<br/><br/> <b>Receive the Ancient Agricola Artifact.</b>"
						]
					},
					"<br/>",
					{
						name: "<b>실패:</b> Lose 2d4 Vita. Another character may attempt it if they wish. Otherwise you may abandon the effort, continue the story."
					}
				],
			},
			"<br/>",
	...
	},
	{
		...
		item: [
			"다큰바우 숲에 역병을 뿌리던 거대한 참나무는 이제 파괴되었다. 하지만 그 힘의 원천은 여전히 남아있다. 선택지는 하나뿐이다. 당신은 놈의 입을 통해 지하로 들어가야만 한다. 당신이 틈을 향해 다가가자, 그 삐죽삐죽한 나무껍질에 끈적한 액체가 묻어있는 것이 보인다.<br/><br/><br/> ...<br/><br/><br/> <b>STORY SKILL CHECK<br/>NERVE 5</b> - All Characters<br/><br/> <b>날카로운 이빨에 주의하며, 당신은 어쩔 수 없이 죽은 나무의 입속으로 발을 들인다.</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 날카로운 이빨을 피해 가능한 조심스럽게 움직인다. Gain 8 Lore."
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신의 노력은 수포로 돌아간다. 당신은 날카로운 나무껍질에 베이고 만다. Lose 2 Vita."
			},
			"<br/><br/>당신은 나무의 몸통으로 들어가, 그 안에 있는 지하 깊은 곳으로 이어지는 가파른 터널로 내려간다. 터널은 나무뿌리를 따라 계속 이어지며 점점 좁아진다. 희미하게 빛나는 보라색 불빛이 당신의 눈에 띈다. 그것은 마치 아직 생명이 남아있는 것 마냥 떨리고는 한다. 갑자기 뿌리가 움직이기 시작하며 터널이 흔들리기 시작한다. 터널이 붕괴하고 있다!<br/><br/><br/> ...<br/><br/><br/> <b>AFTER YOU REACH THE SAFE ZONE</b><br/><br/> 위를 올려다보자, 저 멀리 공중에 반투명한 형체들이 떠다니는 것을 볼 수 있다. 희미한 놈들의 눈동자가 광기로 붉게 빛나며 당신을 향한다.<br/><br/><br/> <b>CHOOSE YOUR PATH</b><br/><br/> <b>이 영혼들은 오래된 과거에 벌어진 충격적인 사건 때문에 이 장소에 얽매여 있다. 당신은 그들을 설득해 떠나게 할 것인가? 아니면 힘으로 그들을 정화할 것인가?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 놈들은 이제 이성 따위는 남아있지 않은 순수한 악의 존재일 뿐이다. 놈들을 공격한다! 조우를 진행한다.",
			},
			"<br/>",
			{
				name: "<b>• 선택 2:</b> 그들에게 빛을 향해 나아갈 기회를 준다.",
				item: [
					"<b>Story Moment 86</b><br/><br/> 당신은 당신의 신앙의 힘을 통해 영혼들에게 이 세상의 굴레를 벗어나 안식을 찾을 길을 보여준다.<br/><br/> <b>One character can make a FAITH 8 check to remove one Restless Spirit from the map and then recover all their Power Points. Additional spirits may be pacified by others during their turn, however the skill check increases to FAITH 9 for the second and FAITH 10 for the last.<br/><br/> If at any time a failure occurs, 그들을 추방하려는 당신의 한심한 노력은 그들을 화나게 하고, you must proceed with the encounter with the remaining spirits. They gain +1 Damage during the fight.</b>"
				]
			},
			"<br/><br/>...<br/><br/><br/> <b>AFTER THE FIGHT</b><br/><br/> 이 버림받은 장소를 지키던 영혼과, 그들의 붉게 빛나던 눈은 이제 영원히 사라져버렸다. 당신은 당신의 발밑에 사람의 손으로 만들어진 건물이 있다는 것을 깨닫는다. 돔 모양의 그것은 아마도 고대 천문대의 지붕으로 보인다. 당신이 따라온 뿌리가 돔의 천장을 뚫고 건물 안으로 이어져 있다. 그 틈을 통해 으스스한 보라색 빛이 새어나온다. 어떻게 이런 건물이 땅속에 묻혀 있을 수 있는 것일까?<br/><br/> 계속 나아갈 수밖에 없다. 당신은 틈새를 통해 지붕 아래로 내려간다."
		]
	},
	{},
	{
	...
	},
	{
		...
		item: [
			...
			"<br/> <b>Once the door is open, and IF THERE ARE NO MAP EFFECTS due to your last Story Moment, you can immediately skip to \"The Grimoire\" on page 16, otherwise you must use get all characters to the Exit Zone.</b><br/><br/><br/> ..."
		]
	},
	{
		name: "STONY DEFENSE (16): 바위같이 단단한 방어",
		item: [
			"바위가 갈라지는 소리가 들리며 가고일 조각상들이 움직이기 시작한다. 놈들의 몸 위로 오랜 세월 켭켭이 쌓여 층을 이룬 먼지와 흙이 부서져 떨어져 나간다.<br/><br/><br/> ..."
		]
	},
	{
		name: "THE GRIMOIRE (16~17): 마도서",
		item: [
			"당신은 곰팡이 핀 테피스트리로 장식된 통로를 따라가다 조금 열린 채 놓여있는 문 앞에 도달한다. 그 너머에는 예배당이 있고, 그 신성한 장소에 어울리지 않는 부정하기 짝이 없는 광경이 펼쳐져 있다. 석탄이 타고 있는 화로가 중앙 통로를 따라 제단까지 이어져 있고, 제단 위에는 까맣게 그을린 가죽으로 장정된 책 한 권이 펼쳐져 있다. 그 책 주변으로 어두운 자줏빛 에너지가 맥동한다. 그것은 마치 당신의 심장 박동과 그 궤를 같이하려는 것만 같다.<br/><br/> 천장의 틈새로부터 거대한 참나무의 뿌리가 수없이 뻗어 나와 마도서가 발하는 어둠의 에너지를 빨아들이고 있다. 당신은 거대한 나무 괴물을 움직이게 하고, 숲과 마을에 역병을 일으킨 힘의 근원을 찾아낸 것이다. 방의 벽과 바닥에는 아주 오랜 과거에 피로 그려진 기묘한 상징들이 가득하며, 방을 둘러싼 모든 벽마다 기이하고 충격적인 그림들이 그려져 있다.<br/><br/> 당신이 책을 향해 다가갈수록, 그것이 당신의 육신으로부터 힘을 빨아들여 자신의 양분으로 삼고 있는 것이 느껴진다. 책이 제단 위 공중으로 떠오른다. 그 표지에는 날카로운 가시가 가득하며, 조금도 깜빡이지 않는 커다란 눈이 달려있다. 당신은 모든 것을 잃기 전에 놈을 멈춰야만 한다!<br/><br/><br/> ..."
		]
	},
	{
	...
	{},
	{
		note: "<b>STORY VI - ORIGINS OF THE FLAME: 불꽃의 기원</b><br/>"
	},
	{
		note: "<b>CHAPTER 1</b><br/>"
	},
	...
	{
		name: "FOLLOWING THE BREADCRUMBS (39): 발자취를 따라",
		item: [
			"당신은 이야기꾼 갈리스티그의 뒤를 쫓기로 한다. 갑작스러운 그의 등장이 마을 사람들의 폭력적인 행동과 관련이 있다는 것은 의심할 여지가 없다. 마을 주민들을 심문할 시간이 더 있었다면 좋았겠지만, 이제 다음 행동을 결정해야 할 때이다.<br/><br/><br/><b>CHOOSE YOUR PATH</b><br/><br/><b>이런 상황에 조언을 구할 만한 사람은 연금술사 또는 집시들일 것이다. 어느 쪽을 선택할 것인가?</b><br/><br/>",
			{
				name: "<b>• 선택 1:</b> 연금술사는 수많은 비밀을 알고 있고, 그 안에는 이 갈라스티그라는 이야기꾼에 대한 것도 있을 것이다. 당신이 그와 이야기를 하기로 한다면,",
				item: [
					"<b>Story Moment 54</b><br/><br/>당신은 연금술사가 이 이야기꾼을 찾는 데 필요한 정보를 가지고 것이라고 믿는다. 그는 무엇을 해야 할지 알 것이다.<br/><br/><b>A Skip to “Ancient knowledge (Choice One)\" on page 39.</b>"
				]
			},
			"<br/>",
			{
				name: "<b>• 선택 2:</b> 집시들은 그들의 재능을 이용해 이 이야기꾼을 찾아낼 수 있을 것이다. 그들은 기꺼이 당신을 도울 것이다. 집시들을 찾아가 보기로 한다면,",
				item: [
					"<b>Story Moment 22</b><br/><br/>당신은 집시들이 그들의 힘을 사용해 사람들을 찾는 모습을 직접 보아왔다. 그들은 분명히 이 이야기꾼을 찾는 방법을 알고 있을 것이다.<br/><br/><b>Skip to “Vision Through The Veil (Choice Two)\" on page 41.</b>"
				]
			},
		]
	},
	{
		name: "ANCIENT KNOWLEDGE (CHOICE ONE) (39~41): 고대의 지식",
		item: [
			"...<br/><br/><br/>당신이 연금술사의 탑에 도착했을 때, 당신은 탑의 에메랄드 빛의 문이 이미 열려 있는 것을 발견한다. 안으로 들어가자, 탑의 유일한 거주자인 연금술사는 바닥에 놓인 알록달록한 방석 위에서 다리를 꼰 채 편안하게 앉아 벽난로를 응시하고 있다. 그는 당신에게로 고개를 돌리지 않은 채, 강렬하고 차분한 목소리로 말한다. \"어서 오시오, 친구들이여. 오늘은 무슨 일로 날 찾아온 것이오?\" 말을 마치고, 그는 몸을 일으킨다. 동방의 예복을 입고 있는 그는 상냥한 미소를 띠고 당신을 바라본다.<br/><br/>당신이 사건에 관한 모든 것을 설명하자, 연금술사는 알겠다는 듯 고개를 끄덕인다. 그는 대답한다. \"그렇소. 최근에 그런 소문을 들었소. 나 역시 그 '이야기꾼'이라는 자가 걱정되는구려. 갈라스티그라는 이름을 들어본 적이 있는지는 확실치 않지만, 어딘가 익숙한 느낌이 드는구려. 자, 나를 도와주시오. 내가 가진 장서 중에 그자의 정체를 밝힐만한 것이 있는지 찾아봐야겠소.\"<br/><br/><br/><b>STORY SKILL CHECK<br/>AWARENESS 8 & OCCULT 8</b> - All Characters (One Success of Each Needed)<br/><br/><b>연금술사의 도서관에서 갈라스티그에 대한 정보를 찾아라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 몇 시간을 찾아본 끝에, 당신은 갈색의 가죽 표지 위에 작은 오각성이 양각된 책 한 권을 발견한다. 책장을 넘기다 보니 그 책에는 당신이 원하던 정보가 있었다. Gain the GREEN Story Marker. A random character receives a Boon.",
			},
			"<br/>",
			{
				name: "<b>실패:</b> 당신은 도움이 될 정보를 찾는 데 실패하지만, 연금술사가 갈라스티그에 관한 책을 찾아낸다.",
			},
			"<br/><br/>그 책은 낡고 군데군데 헤져있다. 책의 여러 곳에서 갈라스티그라는 이름이 언급되고 있지만, 모든 정보를 하나로 합치기는 쉽지 않다. 책의 내용을 미루어 보자면 그는 영혼의 세계를 여행하는 기술에 통달하였으며, 그 덕분에 노화와 죽음을 피할 수 있었던 것으로 보인다. 또한, 그가 불꽃에 매료되어 있었다는 것과, 그가 생각한 대로 불꽃을 조종할 수 있었다는 언급이 있다. 그리고 그가 과거에 벌어졌던 참혹한 사건과 연관되어 있다는 구절이 있으며, 이런 사건들은 오랜 세월에 걸쳐 분포되어 있다. 분명 이것은 추측일 뿐이다. 그렇게 오래 살 수 있는 사람이 존재할 리가 없다. 마지막으로 갈라스티그가 모로이 봉우리(Moroi Peaks)의 고대 요새를 자신의 것으로 삼았다는 언급이 있다.<br/><br/>긴 침묵이 이어진 뒤, 연금술사가 말한다. \"그가 배후에서 이 모든 사건을 조종하고 있는 것 같구려. 모로이 봉우리에 있는 고대 요새로 가서 그자가 숨어 있는 곳을 찾아내야만 하오! 내 고향의 유물을 사용해 마법사의 은신처로 갈 수 있을 것이오. 이 유물은 살아있는 생명체를 다른 장소로 이동시킬 수 있지만, 사람마다 한 번만 사용할 수 있지. 난 내 형제들이 어둠에 타락했을 때 그곳에서 탈출하기 위해 이것을 사용했었다오. 그러니 난 함께 갈 수 없소. 정말 유감이오.\" 연금술사는 그의 실험실로 가서 여러 종류의 희귀하고 이국적인 물질을 섞기 시작한다. 한 시간 정도 지나자 그의 작업이 끝난다. 그는 끈적한 물질이 담긴 유리병을 들고 나타나 말한다. \"방 한가운데로 모이시오. 그러면 장치를 작동시키겠소. 모로이 봉우리로 갈 수 있는 차원문을 만들겠소. 내가 이 차원문을 다시 이용할 수 없는 것처럼, 당신도 이 차원문을 통해 돌아올 수는 없을 것이오.\" 그는 화려한 금속 그릇 모양의 유물을 바닥 중앙에 놓고 유리병에 담긴 물질로 채운다. 그가 유물 위로 손을 가져가자 방에 한기가 스민다. 그릇에서 안개가 피어오르고 눈앞에 모로이 봉우리의 고원으로 이어지는 빛나는 차원문이 나타난다. 연금술사가 소리친다. \"잠깐! 무언가가 오고 있소. 준비하시오!\"<br/><br/>악마들과 함께 조각난 살점을 이어붙여 만든 듯한 인간형의 괴물이 차원문을 통해 튀어나온다. 놈은 유물을 밟아 뭉갠 뒤, 연금술사를 향해 주먹을 휘두른다. 놈의 주먹에 얻어맞은 연금술사는 바닥에 쓰러져 의식을 잃는다.<br/><br/><br/>...<br/><br/><br/><b>AFTER THE FIGHT</b><br/><br/>",
			{
				name: "<b>• If successful,</b>",
				item: [
					"<b>Story Moment 41</b><br/><br/>당신은 황급히 쓰러진 연금술사에게로 달려간다. 다행히 그는 크게 다치지 않았다. 그는 머리를 흔들며 천천히 몸을 일으킨 뒤, 당신이 침입자를 물리쳐 준 것에 대해 감사를 표한다."
				]
			},
			"<br/>",
			{
				name: "<b>• If the entire group was killed,</b>",
				item: [
					"<b>Story Moment 27</b><br/><br/>서서히 의식이 돌아오기 시작하며 입안에 쓴맛이 느껴진다. 차원문이 있던 자리에는 침입자들의 사체가 놓여있다. 연금술사가 말한다. \"당신이 쓰러지는 순간, 난 정신을 차릴 수 있었다오. 그리고 놈들이 일을 망치기 전에, 놈들을 쓰러뜨릴 수 있었지. 그리고 내가 가진 희귀한 영약으로 당신을 소생시켰다오. 그나마 이 정도로 끝난 것이 다행이오.\"<br/><br/><b>See Rulebook “On Death and Dying” on page 32 and follow the instruction of Total Group Death. The group does not have to draw a Tarot card.</b>"
				]
			},
			"<br/><br/>현장을 정리하던 연금술사는 파괴된 유물을 보며 이야기한다. \"아마도 다른 방법이 있을 것이오.\"<br/><br/>\"그 사악한 마법사가 숨어 있는 곳은 모로이 봉우리 높은 곳에 있는 고대 요새라오. 그곳으로 가는 길은 오래전에 무너졌기에 걸어서 갈 방법은 없소. 끊어진 길을 넘어갈 수 있는 의식을 알려주겠소. 이 의식에는 두 가지 재료가 필요하오. 첫 번째는 고란 묘지(Goran Tombs)의 매장지에 자라는 바람의 갈대(Reed of the Wind)이고, 두 번째는 라미노프 숲(Raminov's Wood)의 고대 참나무 뿌리 근처에서만 자라는 만드레이크 뿌리라오. 모로이 봉우리 기슭에 도착하면 이 유리병에 두 가지 재료를 함께 넣으시오.\" 그는 당신에게 진득한 보라색 액체가 반쯤 담긴 유리병을 건네준다. \"땅에 액체를 부어 원을 그린 뒤, 그 안에서 이 주문을 외우시오.\" 그는 당신에게 주문이 담긴 양피지도 건네준다. \"이 의식은 바람의 다리를 만들어 요새로 가는 산길을 건너게 해줄 것이오. 당신이 돌아올 때까지 주문이 지속되길 바랄 뿐이오.\" \"시간이 없소. 당장 가서 갈라스티그를 막아주시오.\"<br/><br/><br/>..."
		]
	},
	{
		name: "VISION THROUGH THE VEIL (CHOICE TWO) (41~42): 장막 너머를 보다",
		item: [
			"...<br/><br/><br/>요로트러스크에 도착한 당신은 유능한 점술가로 알려진 플로리카를 찾아 집시 야영지로 향한다. 그녀라면 교령회를 통해 갈라스티그를 추적할 수 있을지도 모른다. 당신은 그녀의 마차를 찾아가 문을 두드린다.<br/><br/>나이 든 여인이 문을 열고 나와 미소로 당신을 반긴다. 플로리카는 당신을 마차 안으로 안내한다. 당신이 당신의 임무에 대해 설명하자 그녀는 걱정스러운 표정으로 눈썹을 찡그린다. 그녀는 말한다. \"갈라스티그라는 자는 분명 단순한 이야기꾼은 아닌 것 같구려. 하지만 난 그 이름을 들어본 적이 없다오. 그리고 교령회를 열기 위해서는 그의 소지품이 필요하지. 그러니 타로점으로 운명을 엿보도록 합시다.\"<br/><br/>플로리카는 커다란 카드 뭉치를 섞은 뒤, 첫 번째 카드를 뽑아 탁자 위에 올려놓으며 침울하게 말한다. \"좋지 않은 징조로군.\" 그리고 두 번째 카드와 세 번째 카드를 뽑아 배치한다. \"이건 영혼의 세계에 문제가 생겼음을 나타내고, 그리고... 이 마법사 카드를 보시게. 갈라스티그가 이 모든 일의 중심에 있는 것 같구려.\"<br/><br/>\"이제 그자를 인식했으니, 이 마법사 카드를 이용해 교령회를 할 수 있다오. 하지만 이건 일반적인 교령회와는 다르지. 이 타로 카드가 당신이 찾고 있는 사악한 마법사를 찾을 이정표가 되어 줄 것이니, 난 이 카드를 이용해 당신을 장막 너머의 세계로 보낼 것이라오. 당신의 육체 역시 영혼과 함께 장막 너머로 운반될 것이오. 이건 아주 위험한 일이지.\" 플로리카는 일행을 탁자 주변에 둘러서게 한 뒤 서로의 손을 잡으라고 지시한다. 그녀는 탁자 위에 앉아 당신이 알지 못하는 언어를 큰 소리로 외치기 시작한다. 방이 흔들리며 공간이 뒤틀리며 진동과 함께 탁자가 튀어 오른다. 굉음이 당신의 귀를 울린다. 플로리카가 외친다. \"반대편에서 무언가가 넘어오려 하고 있소! 싸울 준비를 하시오!\"<br/><br/><br/><b>CHOOSE YOUR PATH</b><br/><br/>",
			{
				name: "<b>• If you successfully completed Story IV - Plight of the Fortuneteller,</b>",
				item: [
					"<b>Story Moment 23</b><br/><br/>영혼들이 장막을 뚫고 나오려고 할 때, 강력한 영혼이 나타나 놈들을 이 세계 너머로 밀어내는 것이 느껴진다. \"힘내세요, 당신의 도움을 받았던 메리펜입니다. 당신에게 도움이 필요한 것이 느껴져 도우러 왔습니다. 제가 악이 이 세상으로 넘어오는 것을 막았으니, 서두르셔야 합니다. 어서 가세요!\""
				]
			},
			"<br/>",
			{
				name: "<b>• Otherwise, </b>",
				item: [
					"<b>Story Moment 64</b><br/><br/>영혼의 세계에서 풀려난 사악한 존재가 당신을 막는다. Skirmish with a Poltergeist with the skirmish counter at maximum. 전투가 끝난 뒤, 플로리카가 말한다, \"다시 시작하겠소!\" 그녀는 좀 더 위압적인 목소리로 아까와 같은 주문을 외친다. 이번에는 당신의 시야에서 방이 흔적도 없이 사라진다."
				]
			},
			"<br/><br/>플로리카의 목소리가 들려온다. \"조심하시게, 친구들이여. 돌아오고 싶다면 내 이름을 부르면 된다오. 그러면 내가 은빛 줄을 이용해 당신을 현실 세계로 데려오리다.\"<br/><br/>당신이 도착한 곳은 그림자 같은 형체들이 정처 없이 떠돌고 있는 안개가 자욱한 공간이다. 당신 앞에 망토를 뒤집어쓴 남자가 불덩어리를 들고 서 있다. 그는 이곳에 있는 다른 모든 것들과 마찬가지로 영혼처럼 보이지만, 본질적인 부분에서 이상한 점이 있다. 당신이나 다른 영혼들과 다르게 그의 머리 위에는 은빛 줄이 달려 있지 않다. 영혼과 현실 세계의 육체를 연결하는 그것 말이다. 이자가 갈라스티그임이 틀림없다. 안갯속에서 악의를 품은 강력한 영혼들이 모습을 드러내자, 그는 당신을 향해 미소 짓는다. 곧 그의 앞에 공간의 균열이 나타난다. 그 균열 너머로 모로이 봉우리(Morio Peaks) 산속에 있는 고대 요새가 보인다. 그는 당신을 향해 불덩어리를 던진 뒤, 웃음을 터뜨리고는 균열 너머로 사라진다. 그 후, 균열은 사라져버린다. All characters lose 1d4 Vita.<br/><br/><br/>...<br/><br/><br/><b>AFFLICTION ENCOUNTER</b><br/><br/><b>Encounter the Wraith and 2 Poltergeist.</b><br/><br/>• 플로리카가 행한 교령회의 영향으로 characters are not ghosts during this combat.<br/><br/>• If a character is killed, they immediately go to Limbo rather than becoming a ghost.<br/><br/><br/><b>AFTER THE FIGHT</b><br/><br/>",
			{
				name: "<b>• If successful,</b>",
				item: [
					"<b>Story Moment 87</b><br/><br/>갈라스티그는 도망쳤지만, 당신은 그를 찾기 위해 모로이 봉우리의 산속에 있는 요새로 가야 한다는 것을 알게 되었다. 당신이 플로리카의 이름을 외치자, 마치 누군가가 밧줄로 당신을 당기는 듯한 느낌이 든다. 찰나의 순간, 당신은 플로리카의 마차로 되돌아와 있다."
				]
			},
			"<br/>",
			{
				name: "<b>• If the entire group was killed,",
				item: [
					"<b>Story Moment 24</b><br/><br/>어둠이 당신을 감싼다. 아무것도 보이지 않고, 아무것도 들리지 않으며, 아무것도 느낄 수 없다. 마치 영원이 눈앞에 펼쳐져 있는 것처럼 끝없는 공허가 펼쳐져 있을 뿐이다. 무의 공간을 헤매는 답답함이 당신의 가슴을 짓누른다. 갑자기 타는 듯한 통증이 당신의 모든 것을 집어삼키고 당신의 의식이 사라진다. 천천히 눈을 떠보니 당신은 집시 야영지에 있다. 당신 옆에는 플로리카가 무릎을 꿇은 채 눈을 감고 있다. 그녀는 심호흡을 한 뒤 눈을 뜬다. 당신이 의식을 되찾는 모습을 보며 플로리카가 미소 지으며 말한다. \"위험하다고 말하지 않았소. 장막 너머에서 당신의 육체를 되찾아 오는 일은 쉽지 않았지. 솔직히 말하면 거의 포기할 뻔했지만, 자매들과 형제들의 도움으로 당신을 찾을 수 있었다오.\"<br/><br/><b>See Rulebook “On Death and Dying” on page 32 and follow the instruction of Total Group Death. The group does not have to draw a Tarot card.</b>"
				]
			},
			"<br/><br/>당신은 장막 너머에서 경험한 일들을 모두 이야기하기 시작하지만, 플로리카는 손을 들어 당신의 말을 중단시킨다. \"필요한 것은 모두 들은 것 같구려. 그 사악한 마법사가 도망친 곳은 모로이 봉우리 높은 곳에 있는 고대 요새라오. 그곳으로 가는 길은 오래전에 무너져, 걸어서 갈 방법은 없다오. 대신 끊어진 길을 넘어갈 수 있는 의식을 알려 드리리다. 이 의식에는 두 가지 재료가 필요하다오. 첫 번째는 고란 묘지(Goran Tombs)의 매장지에 자라는 바람의 갈대(Reed of the Wind)이고, 두 번째는 라미노프 숲(Raminov's Wood)의 고대 참나무 뿌리 근처에서만 자라는 만드레이크 뿌리지. 모로이 봉우리 기슭에 도착하면 이 유리병에 두 가지 재료를 함께 넣으면 된다오. 이 재료가 없어도 의식을 행할 수는 있지만, 결과를 통제하기 어려울 테지.\" 그녀는 당신에게 진득한 보라색 액체가 반쯤 담긴 유리병을 건네준다. \"땅에 액체를 부어 원을 그린 뒤, 그 안에서 이 주문을 외우시오.\" 그녀는 당신에게 주문이 담긴 양피지도 건네준다. \"이 의식이 성공하면 바람의 다리가 요새로 가는 산길을 건너게 해줄 거라오. 당신이 돌아올 때까지 주문이 지속되길 바랄 뿐이지.\"<br/><br/>\"시간이 없다오. 가서 갈라스티그를 막아주시게.\"<br/><br/><br/>..."
		]
	},
	{},
	{
	...
	{
		name: "THE MANDRAKE (42): 맨드레이크 뿌리",
		item: [
			"...<br/><br/><br/>당신은 거대한 오크 나무를 발견한다. 그것은 오래전 다큰바우 숲에서 마주쳤던 어둠의 나무를 떠올리게 한다. 하지만 이 나무는 그것과는 달리 사악한 악취를 풍기고 있지 않다. 당신은 의식에 필요한 맨드레이크를 찾기 위해 나무뿌리 근처의 땅을 파기 시작한다.<br/><br/><br/><b>STORY SKILL CHECK<br/>ECOLOGY 7</b> - Any One Character<br/><br/><b>거대한 오크 나무의 뿌리 근처에서 맨드레이크를 수확하라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 땅 위로 노출되어 쉽게 캐낼 수 있는 맨드레이크를 찾아낸다. Gain 8 Lore.",
			},
			"<br/>",
			{
				name: "<b>실패:</b> 오크 나무의 썩은 뿌리 사이에서 맨드레이크를 찾아내기란 쉽지 않은 일이다. 결국, 하나를 찾아내긴 하지만, 당신은 몹시 지쳐버렸기에 become SICKENED 8.",
			},

		]
	},
	{
		name: "REED OF THE WIND (42): 바람의 갈대",
		item: [
			"...<br/><br/><br/>매장지의 무덤 사이를 걷는 일은 당신을 우울하게 한다. 당신은 바람의 갈대라 불리는 특별한 갈대를 찾고 있다. 그것은 바람이 불면 마치 울음소리 같은 것을 낸다고 한다. 매장지는 아주 넓기에 뛰어난 관찰력과 함께 약간의 운이 필요할 것이다.<br/><br/><br/><b>STORY SKILL CHECK<br/>AWARENESS 7</b> - Any One Character<br/><br/><b>고란 묘지에서 바람의 갈대를 찾아라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 거센 바람이 불자 갈대가 큰소리로 울부짖는다. 당신은 어렵지 않게 갈대를 손에 넣는다. Gain 8 Lore.",
			},
			"<br/>",
			{
				name: "<b>실패:</b> 바람이 잠잠하기에 당신의 수색은 쉽지 않다. 결국, 하나를 찾아내긴 하지만, 으스스한 곳에서 너무 오랜 시간을 보낸 탓에 you are SPOOKED 7.",
			},
		]
	},
	{
		name: "PERFORMING THE RITE (43): 의식을 수행하다",
		item: [
			"...<br/><br/><br/><b>STORY SKILL CHECK<br/>OCCULT 10</b> - Any Character Until Successful<br/>Receive +2 to this skill check for each of the components you collected (Mandrake and Reed of the Wind).<br/><br/><b>끊어진 길을 넘어갈 의식을 수행하라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 당신은 성공적으로 의식을 끝마친다. 이제 모로이 봉우리로 들어가 버려진 요새로 향할 수 있게 되었다. Gain a Boon.",
			},
			"<br/>",
			{
				name: "<b>실패:</b> 몇 가지 실수한 부분이 있다고 생각하지만, 어쨌든 의식은 효과가 있었던 것 같다. Take the GREEN Story Marker.",
			},
			"<br/><br/>..."
		]
	},
	{
		name: "TO THE TOWER (43): 탑으로",
		item: [
			"당신은 바람으로 만들어진 가파른 다리 위를 걷는다. 당신은 겁에 질려 앞으로 나아가기 쉽지 않다.<br/><br/><br/><b>STORY SKILL CHECK<br/>NERVE 6</b> - All Characters<br/><br/><b>두려움을 극복하고 높은 산의 요새로 나아가라.</b><br/><br/>",
			{
				name: "<b>성공:</b> 그 무엇도 갈라스티그와의 결전을 향해 나아가는 당신을 막을 수 없다. Become BRAVE.",
			},
			"<br/>",
			{
				name: "<b>실패:</b> 추락의 공포를 떨쳐내기란 쉽지 않다. Become SPOOKED 7.",
			},
			"<br/><br/>다리 끝에 도착하자 요새가 보인다. 그것은 아주 오래전에 버려진 것이 틀림없다. 안으로 들어가자 건물 대부분이 무너져 있다는 것을 알 수 있다. 하지만 앞으로 이어지는 통로 하나가 있는데 탑으로 올라가는 계단임이 분명하다. 갑자기 사방에서 불길이 치솟으며 통로가 막힌다. 탑 위에 앉아 있던 가고일 두 마리가 지상으로 내려와 사악한 눈빛으로 당신을 노려보고, 성벽 위에서 마녀 하나가 나타나 당신을 노린다.<br/><br/><br/>..."
		]
	},
	{
		name: "THE FINAL SHOWDOWN (44): 최후의 대결",
		item: [
			"당신은 회전 계단을 올라 탑의 꼭대기로 올라간다. 꼭대기에 도착하자 갈라스티그가 성벽에 기대어 대지를 굽어보고 있다. 그는 당신을 눈치채고 말한다. \"널 기다리고 있었다. 네가 죽으면 이 땅은 나의 것이 될 것이다. 이곳의 인간들은 나약하기 짝이 없지. 그들은 나의 명령을 따르는 완벽한 노예가 될 것이다. 죽음을 통해 그러한 운명을 피할 수 있다는 것을 감사하도록 해라.\" 갈라스티그의 손에 불꽃이 타오르고, 불타는 눈동자를 가진 가고일들이 성벽에서 내려와 전장에 합류한다. \"내 이름은 갈라스티그. 네가 그토록 찾아 헤매던 사람이 바로 나다. 내가 이 모든 혼란을 만들어냈지. 주민들을 조종해 어둠의 마법을 쓰게 한 것이 다가 아니다. 북쪽의 늑대인간들에게 그들이 찾는 광물이 크레멜 산 아래에 있다고 알려준 것도 나이고, 동쪽의 주술사들에게 그들을 배반한 자가 이 땅에 있다는 것을 알려준 것도 나이다. 그 밖에도 네가 알지 못하는 많은 일이 있었지. 하지만 네가 오기 전까지 그 누구도 이곳을 찾아내지 못했다. 그리고 넌 이곳을 찾아냈으니, 그것만으로도 죽어 마땅하다.\"<br/><br/><br/>..."
		]
	},
	{
		name: "STORY CLOSING (44)",
		item: [
			"<b>IF YOU WON THE BATTLE</b><br/><br/>갈라스티그는 피를 흘리며 바닥에 쓰러져 있다. 그는 힘없이 웃으며 말한다. \"네가 이겼다. 다시 돌아올 방법을 찾을 때까지 영혼의 세계를 헤매게 되겠군... 이것으로 끝난 게 아니다... 언제나 돌아올 방법은 있다.\" 그의 눈이 감기고, 숨이 멎음과 동시에 손에서 타오르던 불꽃이 사그라진다.<br/><br/>당신은 그의 말이 옳다는 것을 알고 있다. 물리쳐야 할 악은 언제나 존재했다. 하지만 당신은 어둠에 맞서 싸울 것이고, 놈들을 이 땅에서 몰아낼 것이다. 조금씩 조금씩 어둠은 사라질 것이다. 사람들은 맞서 싸울 것이고, 결국 승리할 것이다.<br/><br/>",
			{
				name: "<b>• All characters receive an additional 50 Lore and 25 Coins. The group also receives the Bracers of the Kabbalist artifact.</b>",
			},
			"<br/>",
			{
				name: "<b>• If you have the BLUE Story Marker,",
				item: [
					"<b>Story Moment 80</b><br/><br/>당신은 갈라스티그에게 조종당했던 주민들을 구속해 오스테링크로 돌아간다. 파수꾼들은 당신과 주민들을 체포해 밧줄로 묶어 치안판사에게 데려간다.<br/><br/><b>갈라스티그에 대한 모든 것을 설명하고, 당신과 주민들이 결백하다는 것을 설득하기 위해 one character must pass SPEECH 6.</b><br/><br/>",
					{
						name: "<b>성공:</b> 판사는 당신에게 무죄 판결을 내리지만, 주민들은 감옥으로 데려가게 한다. 그들은 자신이 초래한 피해를 복구하는 동안 노역형에 처하게 될 것이다. 이 일은 합리적으로 해결된 것 같다. All characters lose the WANTED condition and gain 15 Lore. The character who made the skill check becomes RESPECTED.",
					},
					"<br/>",
					{
						name: "<b>실패:</b> 그들은 당신이 무조건 잘못했다고 생각하지만 않지만, but you must immediately pay the WANTED fine or be forced to skirmish with Watchmen and be exiled from the city until the status is removed. 조종당했던 마을 주민들은 유죄 판결을 받아 즉시 처형된다.",
					},
				]
			},
			"<br/><br/><b>IF YOU LOST THE BATTLE</b><br/><br/>당신은 오스테링크 외곽의 집시 야영지에서 깨어난다. 당신은 잠시 영혼의 세계에서 당신의 영혼을 갈라스티그에게 구속당한 것이 아닌가 하며 겁을 먹고 공황에 빠진다. 하지만 집시들은 그런 일이 없도록 주의하며 당신을 찾아내 살아 돌아오게 했다. (see <b>Rulebook “On Death and Dying\" on page 32</b> and follow the instruction of Total Group Death).<br/><br/>당신은 갈라스티그를 물리치는 데 실패했지만, 그를 영혼의 세계로 물러나게 할 만큼 충분한 상처를 입혔다. 그의 암약은 계속해서 이 땅을 괴롭힐 것이다. 하지만 이제 당신이 그의 존재를 알게 되었으니, 그가 마음대로 활개치게 놔두진 않을 것이다. 만약 그가 당신과 다시 마주치게 된다면, 그의 운은 거기서 끝일 것이다.<br/><br/><br/><b>THE END</b>"
		]
	},
];
